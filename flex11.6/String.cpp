     ...
     */
         ...
         * @playerversion   Lite 4
         */
        std::string String::fromCharCode(...)         ;
         ...
         * @playerversion   AIR 1.0
         * @playerversion   Lite 4
         */int String::indexOf(std::string s, float i)      ;
         ...
         * @playerversion   AIR 1.0
         * @playerversion   Lite 4
         */int String::lastIndexOf(std::string s, float i)      ;
         ...
         * @playerversion   AIR 1.0
         * @playerversion   Lite 4
         */std::string String::charAt(float i)         ;
         ...
         * @playerversion   AIR 1.0
         * @playerversion   Lite 4
         */float String::charCodeAt(float i)         ;
         ...
         * @playerversion   Flash 9
         * @playerversion   AIR 1.0
         */int String::localeCompare(void* other)      ;
         ...
         *   // [[She,e],[she,e],[sho,o]] 
         *   </code></pre>
         */std::vector<void*> String::match(void* p)        ;
         ...
         * @playerversion   Flash 9
         * @playerversion   AIR 1.0
         */std::string String::replace(void* p, void* repl)         ;
         ...
         * @playerversion   Flash 9
         * @playerversion   AIR 1.0
         */std::string String::slice(float start, float end)         ;
         ...
         * @playerversion   Flash 9
         * @playerversion   AIR 1.0
         */std::vector<void*> String::split(void* delim, void* limit)        ;
         ...
         * @playerversion   Flash 9
         * @playerversion   AIR 1.0
         */std::string String::substring(float start, float end)         ;
         ...
         * @playerversion   Flash 9
         * @playerversion   AIR 1.0
         */std::string String::substr(float start, float len)         ;
         ...
         * @playerversion   Flash 9
         * @playerversion   AIR 1.0
         */std::string String::toLocaleUpperCase()         ;std::string String::toString()         ;
