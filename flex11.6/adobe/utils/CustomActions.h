#if !defined(FLEX11_6_ADOBE_UTILS_CUSTOMACTIONS_AS)
#define FLEX11_6_ADOBE_UTILS_CUSTOMACTIONS_AS
...
namespace adobe
{
    namespace utils
    {
        ...
        public:
             ...
             */
        public:
            static void     installActions(std::string name, std::string data);
             ...
             */
        public:
            static void     uninstallActions(std::string name);
...
#endif // FLEX11_6_ADOBE_UTILS_CUSTOMACTIONS_AS
#endif // __cplusplus
