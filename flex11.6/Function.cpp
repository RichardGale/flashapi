     ...
     */
        ...
        const int Function::_length  ;

        void* Function::prototype()    ;
        void Function::prototype(void* p)       ;

        int Function::length()      ;

        Function::Function();

        Function* Function::createEmptyFunction()           ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */void* Function::call(void* thisArg, ...)    ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */void* Function::apply(void* thisArg, void* argArray)    ;
