     ...
     */
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */bool XMLList::hasOwnProperty(void* P)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */bool XMLList::propertyIsEnumerable(void* P)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XMLList::attribute(void* arg)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XMLList::child(void* propertyName)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */bool XMLList::contains(void* value)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XMLList::descendants(void* name)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XMLList::elements(void* name)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */bool XMLList::hasComplexContent()          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */int XMLList::length()      ;Object* XMLList::name()         ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XMLList::processingInstructions(void* name)          ;
