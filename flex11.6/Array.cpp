     ...
     */
        ...
        void Array::length(unsigned int newLength)       ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */std::string Array::join(void* sep)         ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */std::vector<void*> Array::slice(void* A, void* B)        ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */std::vector<void*> Array::sortOn(void* names, void* options, ...)        ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */int Array::indexOf(void* searchElement, void* fromIndex)      ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */int Array::lastIndexOf(void* searchElement, void* fromIndex)      ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */bool Array::every(Function* callback, void* thisObject)          ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */std::vector<void*> Array::filter(Function* callback, void* thisObject)        ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */void Array::forEach(Function* callback, void* thisObject)       ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */std::vector<void*> Array::map(Function* callback, void* thisObject)        ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */bool Array::some(Function* callback, void* thisObject)          ;
