     ...
     */
         ...
         * @playerversion   Lite 4
         */
        float RegExp::lastIndex()         ;
        void RegExp::lastIndex(int i)       ;
         ...
         * @playerversion   Flash 9
         */
        RegExp::RegExp(void* pattern, void* options);
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */Object* RegExp::exec(std::string s)         ;
