#if !defined(FLEX11_6_FLASH_UI_CONTEXTMENU_AS)
#define FLEX11_6_FLASH_UI_CONTEXTMENU_AS
...
namespace flash
{
    namespace ui
    {
         ...
         */
        class ContextMenu : public flash::display::NativeMenu
        {
            /**
        ...
        public:
             ...
             */
        public:
            flash::ui::ContextMenuBuiltInItems *builtInItems();
        public:
            void         builtInItems(ContextMenuBuiltInItems *value);
        ...
        public:
             ...
             */
        public:
            flash::net::URLRequest *link();
        public:
            void         link(URLRequest *value);
        ...
        public:
             ...
             */
        public:
            flash::ui::ContextMenuClipboardItems *clipboardItems();
        public:
            void         clipboardItems(ContextMenuClipboardItems *value);
        ...
        public:
             ...
             */
        public:
            flash::display::NativeMenu *clone();
        };
    }
}

#endif // FLEX11_6_FLASH_UI_CONTEXTMENU_AS
#endif // __cplusplus
