...
namespace ui {
         ...
         * @playerversion   Lite 4
         */
        std::string Multitouch::inputMode()         ;
        void Multitouch::inputMode(std::string value)       ;
         ...
         * @playerversion   Lite 4
         */
        bool Multitouch::supportsTouchEvents()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Multitouch::supportsGestureEvents()          ;
         ...
         * @playerversion   Lite 4
         */
        std::vector<std::string> Multitouch::supportedGestures()                  ;
         ...
         * @playerversion   Lite 4
         */
        int Multitouch::maxTouchPoints()      ;

        bool Multitouch::mapTouchToMouse()          ;
        void Multitouch::mapTouchToMouse(bool value)       ;
