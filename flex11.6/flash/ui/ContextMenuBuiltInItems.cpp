...
namespace ui {
         ...
         * @playerversion   Flash 9
         */
        bool ContextMenuBuiltInItems::save()          ;
        void ContextMenuBuiltInItems::save(bool val)       ;
         ...
         * @playerversion   Flash 9
         */
        bool ContextMenuBuiltInItems::zoom()          ;
        void ContextMenuBuiltInItems::zoom(bool val)       ;
         ...
         * @playerversion   Flash 9
         */
        bool ContextMenuBuiltInItems::quality()          ;
        void ContextMenuBuiltInItems::quality(bool val)       ;
         ...
         * @playerversion   Flash 9
         */
        bool ContextMenuBuiltInItems::play()          ;
        void ContextMenuBuiltInItems::play(bool val)       ;
         ...
         * @playerversion   Flash 9
         */
        bool ContextMenuBuiltInItems::loop()          ;
        void ContextMenuBuiltInItems::loop(bool val)       ;
         ...
         * @playerversion   Flash 9
         */
        bool ContextMenuBuiltInItems::rewind()          ;
        void ContextMenuBuiltInItems::rewind(bool val)       ;
         ...
         * @playerversion   Flash 9
         */
        bool ContextMenuBuiltInItems::forwardAndBack()          ;
        void ContextMenuBuiltInItems::forwardAndBack(bool val)       ;
         ...
         * @playerversion   Flash 9
         */
        bool ContextMenuBuiltInItems::print()          ;
        void ContextMenuBuiltInItems::print(bool val)       ;
        ...
        ContextMenuBuiltInItems* ContextMenuBuiltInItems::clone()                          ;
}
}
