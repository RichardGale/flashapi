...
namespace ui {
         ...
         * @playerversion   AIR 2.6
         */
        std::vector<flash::display::BitmapData*> MouseCursorData::data()                                    ;
        void MouseCursorData::data(std::vector<BitmapData*> data)       ;
         ...
         * @playerversion   AIR 2.6
         */
        flash::geom::Point* MouseCursorData::hotSpot()                   ;
        void MouseCursorData::hotSpot(Point* data)       ;
         ...
         * @playerversion   AIR 2.6
         */
        float MouseCursorData::frameRate()         ;
        void MouseCursorData::frameRate(float data)       ;
