...
namespace filters {
         ...
         *   </listing>
         */
        unsigned int GlowFilter::color()       ;
        void GlowFilter::color(unsigned int value)       ;
         ...
         *   </listing>
         */
        float GlowFilter::alpha()         ;
        void GlowFilter::alpha(float value)       ;
         ...
         *   </listing>
         */
        float GlowFilter::blurX()         ;
        void GlowFilter::blurX(float value)       ;
         ...
         *   </listing>
         */
        float GlowFilter::blurY()         ;
        void GlowFilter::blurY(float value)       ;
         ...
         *   </listing>
         */
        bool GlowFilter::inner()          ;
        void GlowFilter::inner(bool value)       ;
         ...
         *   </listing>
         */
        bool GlowFilter::knockout()          ;
        void GlowFilter::knockout(bool value)       ;
         ...
         *   </listing>
         */
        int GlowFilter::quality()      ;
        void GlowFilter::quality(int value)       ;
         ...
         *   </listing>
         */
        float GlowFilter::strength()         ;
        void GlowFilter::strength(float value)       ;
         ...
         *   </listing>
         */
        GlowFilter::GlowFilter(unsigned int color, float alpha, float blurX, float blurY, float strength, int quality, bool inner, bool knockout);
         ...
         *   </listing>
         */
        flash::filters::BitmapFilter* GlowFilter::clone()                             ;
}
}
