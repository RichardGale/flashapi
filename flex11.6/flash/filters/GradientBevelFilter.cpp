...
namespace filters {
         ...
         *   </listing>
         */
        float GradientBevelFilter::distance()         ;
        void GradientBevelFilter::distance(float value)       ;
         ...
         *   </listing>
         */
        float GradientBevelFilter::angle()         ;
        void GradientBevelFilter::angle(float value)       ;
         ...
         */
        std::vector<void*> GradientBevelFilter::colors()        ;
        void GradientBevelFilter::colors(std::vector<void*> value)       ;
         ...
         * @throws  TypeError The Array is null when being set
         */
        std::vector<void*> GradientBevelFilter::alphas()        ;
        void GradientBevelFilter::alphas(std::vector<void*> value)       ;
         ...
         * @throws  TypeError The Array is null when being set
         */
        std::vector<void*> GradientBevelFilter::ratios()        ;
        void GradientBevelFilter::ratios(std::vector<void*> value)       ;
         ...
         *   </listing>
         */
        float GradientBevelFilter::blurX()         ;
        void GradientBevelFilter::blurX(float value)       ;
         ...
         *   </listing>
         */
        float GradientBevelFilter::blurY()         ;
        void GradientBevelFilter::blurY(float value)       ;
         ...
         *   </listing>
         */
        bool GradientBevelFilter::knockout()          ;
        void GradientBevelFilter::knockout(bool value)       ;
         ...
         *   </listing>
         */
        int GradientBevelFilter::quality()      ;
        void GradientBevelFilter::quality(int value)       ;
         ...
         *   </listing>
         */
        float GradientBevelFilter::strength()         ;
        void GradientBevelFilter::strength(float value)       ;
         ...
         *   </listing>
         */
        std::string GradientBevelFilter::type()         ;
        void GradientBevelFilter::type(std::string value)       ;
         ...
         */
        GradientBevelFilter::GradientBevelFilter(float distance, float angle, std::vector<void*> colors, std::vector<void*> alphas, std::vector<void*> ratios, float blurX, float blurY, float strength, int quality, std::string type, bool knockout);
         ...
         *     </listing>
         */
        flash::filters::BitmapFilter* GradientBevelFilter::clone()                             ;
}
}
