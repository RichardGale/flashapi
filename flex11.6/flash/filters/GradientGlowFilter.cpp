...
namespace filters {
         ...
         *   </listing>
         */
        float GradientGlowFilter::angle()         ;
        void GradientGlowFilter::angle(float value)       ;
         ...
         */
        std::vector<void*> GradientGlowFilter::alphas()        ;
        void GradientGlowFilter::alphas(std::vector<void*> value)       ;
         ...
         * @playerversion   Flash 9
         */
        float GradientGlowFilter::blurX()         ;
        void GradientGlowFilter::blurX(float value)       ;
         ...
         * @playerversion   Flash 9
         */
        float GradientGlowFilter::blurY()         ;
        void GradientGlowFilter::blurY(float value)       ;
         ...
         * @throws  TypeError The Array is null when being set
         */
        std::vector<void*> GradientGlowFilter::colors()        ;
        void GradientGlowFilter::colors(std::vector<void*> value)       ;
         ...
         *   </listing>
         */
        float GradientGlowFilter::distance()         ;
        void GradientGlowFilter::distance(float value)       ;
         ...
         *     </listing>
         */
        bool GradientGlowFilter::knockout()          ;
        void GradientGlowFilter::knockout(bool value)       ;
         ...
         *   </listing>
         */
        int GradientGlowFilter::quality()      ;
        void GradientGlowFilter::quality(int value)       ;
         ...
         * @throws  TypeError The Array is null when being set
         */
        std::vector<void*> GradientGlowFilter::ratios()        ;
        void GradientGlowFilter::ratios(std::vector<void*> value)       ;
         ...
         *   </listing>
         */
        float GradientGlowFilter::strength()         ;
        void GradientGlowFilter::strength(float value)       ;
         ...
         */
        std::string GradientGlowFilter::type()         ;
        void GradientGlowFilter::type(std::string value)       ;
         ...
         *   </listing>
         */
        GradientGlowFilter::GradientGlowFilter(float distance, float angle, std::vector<void*> colors, std::vector<void*> alphas, std::vector<void*> ratios, float blurX, float blurY, float strength, int quality, std::string type, bool knockout);
         ...
         *   </listing>
         */
        flash::filters::BitmapFilter* GradientGlowFilter::clone()                             ;
}
}
