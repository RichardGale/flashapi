...
namespace filters {
         ...
         *   </listing>
         */
        float DropShadowFilter::distance()         ;
        void DropShadowFilter::distance(float value)       ;
         ...
         *   </listing>
         */
        float DropShadowFilter::angle()         ;
        void DropShadowFilter::angle(float value)       ;
         ...
         *   </listing>
         */
        unsigned int DropShadowFilter::color()       ;
        void DropShadowFilter::color(unsigned int value)       ;
         ...
         *   </listing>
         */
        float DropShadowFilter::alpha()         ;
        void DropShadowFilter::alpha(float value)       ;
         ...
         *   </listing>
         */
        float DropShadowFilter::blurX()         ;
        void DropShadowFilter::blurX(float value)       ;
         ...
         *   </listing>
         */
        float DropShadowFilter::blurY()         ;
        void DropShadowFilter::blurY(float value)       ;
         ...
         *   </listing>
         */
        bool DropShadowFilter::hideObject()          ;
        void DropShadowFilter::hideObject(bool value)       ;
         ...
         *   </listing>
         */
        bool DropShadowFilter::inner()          ;
        void DropShadowFilter::inner(bool value)       ;
         ...
         *   </listing>
         */
        bool DropShadowFilter::knockout()          ;
        void DropShadowFilter::knockout(bool value)       ;
         ...
         *   </listing>
         */
        int DropShadowFilter::quality()      ;
        void DropShadowFilter::quality(int value)       ;
         ...
         *   </listing>
         */
        float DropShadowFilter::strength()         ;
        void DropShadowFilter::strength(float value)       ;
         ...
         *   </pre>
         */
        DropShadowFilter::DropShadowFilter(float distance, float angle, unsigned int color, float alpha, float blurX, float blurY, float strength, int quality, bool inner, bool knockout, bool hideObject);
         ...
         *   </listing>
         */
        flash::filters::BitmapFilter* DropShadowFilter::clone()                             ;
}
}
