...
namespace filters {
         ...
         */
        std::vector<void*> ConvolutionFilter::matrix()        ;
        void ConvolutionFilter::matrix(std::vector<void*> value)       ;
         ...
         *   </listing>
         */
        float ConvolutionFilter::matrixX()         ;
        void ConvolutionFilter::matrixX(float value)       ;
         ...
         *   </listing>
         */
        float ConvolutionFilter::matrixY()         ;
        void ConvolutionFilter::matrixY(float value)       ;
         ...
         *   </listing>
         */
        float ConvolutionFilter::divisor()         ;
        void ConvolutionFilter::divisor(float value)       ;
         ...
         *   </listing>
         */
        float ConvolutionFilter::bias()         ;
        void ConvolutionFilter::bias(float value)       ;
         ...
         *   </listing>
         */
        bool ConvolutionFilter::preserveAlpha()          ;
        void ConvolutionFilter::preserveAlpha(bool value)       ;
         ...
         * @playerversion   Flash 9
         */
        bool ConvolutionFilter::clamp()          ;
        void ConvolutionFilter::clamp(bool value)       ;
         ...
         *   </listing>
         */
        unsigned int ConvolutionFilter::color()       ;
        void ConvolutionFilter::color(unsigned int value)       ;
         ...
         *   </listing>
         */
        float ConvolutionFilter::alpha()         ;
        void ConvolutionFilter::alpha(float value)       ;
         ...
         *   </listing>
         */
        ConvolutionFilter::ConvolutionFilter(float matrixX, float matrixY, std::vector<void*> matrix, float divisor, float bias, bool preserveAlpha, bool clamp, unsigned int color, float alpha);
         ...
         *   </listing>
         */
        flash::filters::BitmapFilter* ConvolutionFilter::clone()                             ;
}
}
