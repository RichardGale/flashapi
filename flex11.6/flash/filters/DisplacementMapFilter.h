#if !defined(FLEX11_6_FLASH_FILTERS_DISPLACEMENTMAPFILTER_AS)
#define FLEX11_6_FLASH_FILTERS_DISPLACEMENTMAPFILTER_AS
...
namespace flash
{
    namespace filters
    {
        class DisplacementMapFilter : public flash::filters::BitmapFilter
        {
             ...
             */
        public:
            flash::display::BitmapData *mapBitmap();
        public:
            void         mapBitmap(BitmapData *value);
             ...
             */
        public:
            flash::geom::Point *mapPoint();
        public:
            void         mapPoint(Point *value);
...
#endif // FLEX11_6_FLASH_FILTERS_DISPLACEMENTMAPFILTER_AS
#endif // __cplusplus
