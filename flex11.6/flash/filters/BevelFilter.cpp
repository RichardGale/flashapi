...
namespace filters {
         ...
         *   </listing>
         */
        float BevelFilter::distance()         ;
        void BevelFilter::distance(float value)       ;
         ...
         *   </listing>
         */
        float BevelFilter::angle()         ;
        void BevelFilter::angle(float value)       ;
         ...
         *   </listing>
         */
        unsigned int BevelFilter::highlightColor()       ;
        void BevelFilter::highlightColor(unsigned int value)       ;
         ...
         *   </listing>
         */
        float BevelFilter::highlightAlpha()         ;
        void BevelFilter::highlightAlpha(float value)       ;
         ...
         *   </listing>
         */
        unsigned int BevelFilter::shadowColor()       ;
        void BevelFilter::shadowColor(unsigned int value)       ;
         ...
         *   </listing>
         */
        float BevelFilter::shadowAlpha()         ;
        void BevelFilter::shadowAlpha(float value)       ;
         ...
         *   </listing>
         */
        float BevelFilter::blurX()         ;
        void BevelFilter::blurX(float value)       ;
         ...
         *   </listing>
         */
        float BevelFilter::blurY()         ;
        void BevelFilter::blurY(float value)       ;
         ...
         *   </listing>
         */
        bool BevelFilter::knockout()          ;
        void BevelFilter::knockout(bool value)       ;
         ...
         *   </listing>
         */
        int BevelFilter::quality()      ;
        void BevelFilter::quality(int value)       ;
         ...
         *   </listing>
         */
        float BevelFilter::strength()         ;
        void BevelFilter::strength(float value)       ;
         ...
         */
        std::string BevelFilter::type()         ;
        void BevelFilter::type(std::string value)       ;
         ...
         *   </listing>
         */
        BevelFilter::BevelFilter(float distance, float angle, unsigned int highlightColor, float highlightAlpha, unsigned int shadowColor, float shadowAlpha, float blurX, float blurY, float strength, int quality, std::string type, bool knockout);
         ...
         *   </listing>
         */
        flash::filters::BitmapFilter* BevelFilter::clone()                             ;
}
}
