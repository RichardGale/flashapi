...
namespace filters {
         ...
         *   </listing>
         */
        int BlurFilter::quality()      ;
        void BlurFilter::quality(int value)       ;
         ...
         *   </listing>
         */
        BlurFilter::BlurFilter(float blurX, float blurY, int quality);
         ...
         *   </listing>
         */
        flash::filters::BitmapFilter* BlurFilter::clone()                             ;
}
}
