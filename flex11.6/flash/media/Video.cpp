...
namespace media {
         ...
         * @playerversion   Lite 4
         */
        int Video::deblocking()      ;
        void Video::deblocking(int value)       ;
         ...
         * @playerversion   Lite 4
         */
        bool Video::smoothing()          ;
        void Video::smoothing(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        void Video::attachNetStream(NetStream* netStream)       ;
         ...
         * @playerversion   Flash 9
         */
        void Video::attachCamera(Camera* camera)       ;
}
}
