#if !defined(FLEX11_6_FLASH_MEDIA_SOUNDLOADERCONTEXT_AS)
#define FLEX11_6_FLASH_MEDIA_SOUNDLOADERCONTEXT_AS
 ...
 *
 *   <p class="- topic/p ">When you use this class, consider the following security model: </p><ul class="- topic/ul "><li class="- topic/li ">Loading and playing a sound is not allowed if the calling file is in a network sandbox
 ...
 * and <codeph class="+ topic/ph pr-d/codeph ">SoundTransform()</codeph> methods.</li></ul><p class="- topic/p ">However, in Adobe AIR, content in the <codeph class="+ topic/ph pr-d/codeph ">application</codeph> security sandbox (content
...
#endif // FLEX11_6_FLASH_MEDIA_SOUNDLOADERCONTEXT_AS
#endif // __cplusplus
