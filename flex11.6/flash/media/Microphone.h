...
namespace flash
{
    namespace media
    {
        class Microphone: public EventDispatcher
        {
            /**
        ...
        public:
             ...
             */
        public:
            static flash::media::Microphone *getMicrophone(int index);
        ...
        public:
             ...
             */
        public:
            static flash::media::Microphone *getEnhancedMicrophone(int index);
             ...
             */
        public:
            void     setSilenceLevel(float silenceLevel, int timeout);
