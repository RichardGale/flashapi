#if !defined(FLEX11_6_FLASH_MEDIA_MICROPHONE_AS)
#define FLEX11_6_FLASH_MEDIA_MICROPHONE_AS
...
namespace flash
{
    namespace media
    {
         ...
         */
        class Microphone : public flash::events::EventDispatcher
        {
            /**
        ...
        public:
            int          framesPerPacket();
        public:
            void         framesPerPacket(int frames);
        ...
        public:
            int          encodeQuality();
        public:
            void         encodeQuality(int quality);
        ...
        public:
            void         noiseSuppressionLevel(int level);
        ...
        public:
             ...
             */
        public:
            flash::media::MicrophoneEnhancedOptions *enhancedOptions();
        public:
            void         enhancedOptions(MicrophoneEnhancedOptions *options);
             ...
             */
        public:
            static flash::media::Microphone *getMicrophone(int index=-1);
        ...
        public:
             ...
             */
        public:
            static flash::media::Microphone *getEnhancedMicrophone(int index=-1);
             ...
             */
        public:
            void     setSilenceLevel(float silenceLevel, int timeout=-1);
...
#endif // FLEX11_6_FLASH_MEDIA_MICROPHONE_AS
#endif // __cplusplus
