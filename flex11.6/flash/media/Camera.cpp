...
namespace media {
         ...
         * @playerversion   Flash 9
         */
        flash::media::Camera* Camera::getCamera(std::string name)                     ;

        void Camera::setCursor(bool value)       ;
         ...
         * @playerversion   Flash 9
         */
        void Camera::setKeyFrameInterval(int keyFrameInterval)       ;
         ...
         * @playerversion   Flash 9
         */
        void Camera::setLoopback(bool compress)       ;
         ...
         * @playerversion   Flash 9
         */
        void Camera::setMode(int width, int height, float fps, bool favorArea)       ;
         ...
         * @playerversion   Flash 9
         */
        void Camera::setMotionLevel(int motionLevel, int timeout)       ;
         ...
         * @playerversion   Flash 9
         */
        void Camera::setQuality(int bandwidth, int quality)       ;

        void Camera::drawToBitmapData(BitmapData* destination)       ;

        void Camera::copyToByteArray(Rectangle* rect, ByteArray* destination)       ;

        void Camera::copyToVector(Rectangle* rect, std::vector<unsigned int> destination)       ;
}
}
