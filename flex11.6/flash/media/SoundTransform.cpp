...
namespace media {
         ...
         * @refpath
         */
        float SoundTransform::volume()         ;
        void SoundTransform::volume(float volume)       ;
         ...
         * @refpath
         */
        float SoundTransform::leftToLeft()         ;
        void SoundTransform::leftToLeft(float leftToLeft)       ;
         ...
         * @refpath
         */
        float SoundTransform::leftToRight()         ;
        void SoundTransform::leftToRight(float leftToRight)       ;
         ...
         * @refpath
         */
        float SoundTransform::rightToRight()         ;
        void SoundTransform::rightToRight(float rightToRight)       ;
         ...
         * @refpath
         */
        float SoundTransform::rightToLeft()         ;
        void SoundTransform::rightToLeft(float rightToLeft)       ;
         ...
         * @refpath
         */
        float SoundTransform::pan()         ;
        void SoundTransform::pan(float panning)       ;
         ...
         * @refpath
         */
        SoundTransform::SoundTransform(float vol, float panning);
}
}
