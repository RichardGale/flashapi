...
namespace media {
         ...
         * @refpath
         */
        unsigned int Sound::bytesLoaded()       ;
         ...
         *   platform component).
         */
        void Sound::load(URLRequest* stream, SoundLoaderContext* context)       ;

        void Sound::loadCompressedDataFromByteArray(ByteArray* bytes, unsigned int bytesLength)       ;

        void Sound::loadPCMFromByteArray(ByteArray* bytes, unsigned int samples, std::string format, bool stereo, float sampleRate)       ;
         ...
         * @refpath
         */
        Sound::Sound(URLRequest* stream, SoundLoaderContext* context);
         ...
         * @refpath
         */
        flash::media::SoundChannel* Sound::play(float startTime, int loops, SoundTransform* sndTransform)                           ;
         ...
         * @refpath
         */
        float Sound::extract(ByteArray* target, float length, float startPosition)         ;
}
}
