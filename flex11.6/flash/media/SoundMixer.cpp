...
namespace media {
         ...
         * @refpath
         */
        int SoundMixer::bufferTime()      ;
        void SoundMixer::bufferTime(int bufferTime)       ;
         ...
         * @refpath
         */
        flash::media::SoundTransform* SoundMixer::soundTransform()                             ;
        void SoundMixer::soundTransform(SoundTransform* sndTransform)       ;

        std::string SoundMixer::audioPlaybackMode()         ;
        void SoundMixer::audioPlaybackMode(std::string value)       ;

        bool SoundMixer::useSpeakerphoneForVoice()          ;
        void SoundMixer::useSpeakerphoneForVoice(bool value)       ;
         ...
         */
        void SoundMixer::computeSpectrum(ByteArray* outputArray, bool FFTMode, int stretchFactor)       ;
         ...
         * @refpath
         */
        bool SoundMixer::areSoundsInaccessible()          ;
}
}
