...
namespace engine {
         ...
         * @playerversion   Lite 4
         */
        void TextElement::text(std::string value)       ;
         ...
         */
        void TextElement::replaceText(int beginIndex, int endIndex, std::string newText)       ;
         ...
         * @playerversion   Lite 4
         */
        TextElement::TextElement(std::string text, ElementFormat* elementFormat, EventDispatcher* eventMirror, std::string textRotation);
}
}
}
