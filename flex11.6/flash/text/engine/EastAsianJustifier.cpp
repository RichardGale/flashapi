...
namespace engine {
         ...
         * @playerversion   Lite 4
         */
        std::string EastAsianJustifier::justificationStyle()         ;
        void EastAsianJustifier::justificationStyle(std::string value)       ;

        bool EastAsianJustifier::composeTrailingIdeographicSpaces()          ;
        void EastAsianJustifier::composeTrailingIdeographicSpaces(bool value)       ;
         ...
         */
        EastAsianJustifier::EastAsianJustifier(std::string locale, std::string lineJustification, std::string justificationStyle);
         ...
         */
        flash::text::engine::TextJustifier* EastAsianJustifier::clone()                                  ;
}
}
}
