...
#include "flash/text/engine/TextLineMirrorRegion.h"
...
namespace engine {
         ...
         * @playerversion   Lite 4
         */
        const int TextLine::MAX_LINE_WIDTH   = 1000000;
        ...
        void TextLine::focusRect(Object* focusRect)       ;

        void TextLine::tabChildren(bool enable)       ;

        void TextLine::tabEnabled(bool enabled)       ;

        void TextLine::tabIndex(int index)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::text::engine::TextBlock* TextLine::textBlock()                              ;
         ...
         * @playerversion   Lite 4
         */
        bool TextLine::hasGraphicElement()          ;
         ...
         * @playerversion   Lite 4
         */
        flash::text::engine::TextLine* TextLine::nextLine()                             ;
         ...
         * @playerversion   Lite 4
         */
        flash::text::engine::TextLine* TextLine::previousLine()                             ;
         ...
         * @playerversion   Lite 4
         */
        int TextLine::textBlockBeginIndex()      ;
         ...
         * @playerversion   Lite 4
         */
        float TextLine::unjustifiedTextWidth()         ;
         ...
         */
        std::string TextLine::validity()         ;
        void TextLine::validity(std::string value)       ;
         ...
         * @playerversion   Lite 4
         */
        std::vector<flash::text::engine::TextLineMirrorRegion*> TextLine::mirrorRegions()                                                  ;

        void TextLine::contextMenu(ContextMenu* value)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::text::engine::TextLineMirrorRegion* TextLine::getMirrorRegion(EventDispatcher* mirror)                                         ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        int TextLine::getAtomIndexAtPoint(float stageX, float stageY)      ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        int TextLine::getAtomIndexAtCharIndex(int charIndex)      ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        flash::geom::Rectangle* TextLine::getAtomBounds(int atomIndex)                       ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        int TextLine::getAtomBidiLevel(int atomIndex)      ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        std::string TextLine::getAtomTextRotation(int atomIndex)         ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        int TextLine::getAtomTextBlockBeginIndex(int atomIndex)      ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        int TextLine::getAtomTextBlockEndIndex(int atomIndex)      ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        float TextLine::getAtomCenter(int atomIndex)         ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        bool TextLine::getAtomWordBoundaryOnLeft(int atomIndex)          ;
         ...
         * @throws  IllegalOperationError The validity of the line is TextLineValidity.STATIC.
         */
        flash::display::DisplayObject* TextLine::getAtomGraphic(int atomIndex)                              ;
         ...
         */
        float TextLine::getBaselinePosition(std::string baseline)         ;
