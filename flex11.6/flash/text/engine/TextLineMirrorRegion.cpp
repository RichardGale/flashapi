...
#include "TextLineMirrorRegion.h"
...
namespace engine {
         ...
         * @playerversion   Lite 4
         */
        flash::text::engine::TextLine* TextLineMirrorRegion::textLine()                             ;
         ...
         * @playerversion   Lite 4
         */
        flash::text::engine::TextLineMirrorRegion* TextLineMirrorRegion::nextRegion()                                         ;
         ...
         * @playerversion   Lite 4
         */
        flash::text::engine::TextLineMirrorRegion* TextLineMirrorRegion::previousRegion()                                         ;
         ...
         * @playerversion   Lite 4
         */
        flash::events::EventDispatcher* TextLineMirrorRegion::mirror()                               ;
         ...
         */
        flash::text::engine::ContentElement* TextLineMirrorRegion::element()                                   ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Rectangle* TextLineMirrorRegion::bounds()                       ;

        TextLineMirrorRegion::TextLineMirrorRegion();
}
}
}
