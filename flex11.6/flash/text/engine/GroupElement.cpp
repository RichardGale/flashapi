...
#include "flash/text/engine/TextElement.h"
...
namespace engine {
         ...
         */
        flash::text::engine::ContentElement* GroupElement::getElementAt(int index)                                   ;
         ...
         *   the elements.
         */
        GroupElement::GroupElement(std::vector<flash::text::engine::ContentElement*> elements, ElementFormat* elementFormat, EventDispatcher* eventMirror, std::string textRotation);
         ...
         */
        void GroupElement::setElements(std::vector<flash::text::engine::ContentElement*> value)       ;
         ...
         */
        flash::text::engine::GroupElement* GroupElement::groupElements(int beginIndex, int endIndex)                                 ;
         ...
         */
        void GroupElement::ungroupElements(int groupIndex)       ;
         ...
         */
        flash::text::engine::TextElement* GroupElement::mergeTextElements(int beginIndex, int endIndex)                                ;
         ...
         */
        flash::text::engine::TextElement* GroupElement::splitTextElement(int elementIndex, int splitIndex)                                ;
         ...
         * @throws  ArgumentError If the operation would result in nested rotations within the GroupElement.
         */
        std::vector<flash::text::engine::ContentElement*> GroupElement::replaceElements(int beginIndex, int endIndex, std::vector<flash::text::engine::ContentElement*> newElements)                                            ;
         ...
         */
        flash::text::engine::ContentElement* GroupElement::getElementAtCharIndex(int charIndex)                                   ;
         ...
         * @playerversion   Lite 4
         */
        int GroupElement::getElementIndex(ContentElement* element)      ;
}
}
}
