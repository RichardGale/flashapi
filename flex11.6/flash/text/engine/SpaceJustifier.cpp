...
#include "SpaceJustifier.h"
#include "flash/text/engine/TextJustifier.h"
#include "flash/text/engine/SpaceJustifier.h"
...
namespace engine {
         ...
         * @playerversion   Lite 4
         */
        bool SpaceJustifier::letterSpacing()          ;
        void SpaceJustifier::letterSpacing(bool value)       ;
         ...
         */
        float SpaceJustifier::minimumSpacing()         ;
        void SpaceJustifier::minimumSpacing(float value)       ;
         ...
         */
        float SpaceJustifier::optimumSpacing()         ;
        void SpaceJustifier::optimumSpacing(float value)       ;
         ...
         */
        float SpaceJustifier::maximumSpacing()         ;
        void SpaceJustifier::maximumSpacing(float value)       ;
         ...
         */
        flash::text::engine::TextJustifier* SpaceJustifier::clone()                                  ;
         ...
         */
        SpaceJustifier::SpaceJustifier(std::string locale, std::string lineJustification, bool letterSpacing);
}
}
}
