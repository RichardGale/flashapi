...
namespace engine {
         ...
         * @playerversion   Lite 4
         */
        FontMetrics::FontMetrics(Rectangle* emBox, float strikethroughOffset, float strikethroughThickness, float underlineOffset, float underlineThickness, float subscriptOffset, float subscriptScale, float superscriptOffset, float superscriptScale, float lineGap);
}
}
}
