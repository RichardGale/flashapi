#if !defined(FLEX11_6_FLASH_TEXT_ENGINE_TEXTBLOCK_AS)
#define FLEX11_6_FLASH_TEXT_ENGINE_TEXTBLOCK_AS
    ...
    namespace text
    {
        namespace engine
        {
            ...
            public:
                 ...
                 */
            public:
                flash::text::engine::FontDescription *baselineFontDescription();
            public:
                void         baselineFontDescription(FontDescription *value);
            ...
            public:
                 ...
                 */
            public:
                flash::text::engine::ContentElement *content();
            public:
                void         content(ContentElement *value);
            ...
            public:
                 ...
                 */
            public:
                flash::text::engine::TextLine *firstInvalidLine();
                 ...
                 */
            public:
                flash::text::engine::TextLine *firstLine();
                 ...
                 */
            public:
                flash::text::engine::TextLine *lastLine();
                 ...
                 */
            public:
                flash::text::engine::TextJustifier *textJustifier();
            public:
                void         textJustifier(TextJustifier *value);
            ...
            public:
                 ...
                 */
            public:
                flash::text::engine::TextLine *getTextLineAtCharIndex(int charIndex);
            ...
            public:
                 ...
                 */
            public:
                void     releaseLines(TextLine *firstLine, TextLine *lastLine);
...
#endif // FLEX11_6_FLASH_TEXT_ENGINE_TEXTBLOCK_AS
#endif // __cplusplus
