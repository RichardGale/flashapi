#if !defined(FLEX11_6_FLASH_TEXT_ENGINE_CONTENTELEMENT_AS)
#define FLEX11_6_FLASH_TEXT_ENGINE_CONTENTELEMENT_AS
    ...
    namespace text
    {
        namespace engine
        {
            class ContentElement : public Object
            {
                 ...
                 */
            public:
                static const unsigned int GRAPHIC_ELEMENT;
            ...
            public:
                 ...
                 */
            public:
                flash::text::engine::ElementFormat *elementFormat();
            public:
                void         elementFormat(ElementFormat *value);
                 ...
                 */
            public:
                flash::events::EventDispatcher *eventMirror();
            public:
                void         eventMirror(EventDispatcher *value);
                 ...
                 */
            public:
                flash::text::engine::GroupElement *groupElement();
...
#endif // FLEX11_6_FLASH_TEXT_ENGINE_CONTENTELEMENT_AS
#endif // __cplusplus
