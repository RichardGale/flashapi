...
namespace engine {
         ...
         */
        std::string FontDescription::renderingMode()         ;
        void FontDescription::renderingMode(std::string value)       ;
         ...
         * @throws  IllegalOperationError If set after the FontDescription object is locked (locked is true).
         */
        std::string FontDescription::fontLookup()         ;
        void FontDescription::fontLookup(std::string value)       ;
         ...
         * @throws  IllegalOperationError If set after the FontDescription object is locked (locked is true).
         */
        std::string FontDescription::fontName()         ;
        void FontDescription::fontName(std::string value)       ;
         ...
         * @throws  IllegalOperationError If set after the FontDescription object is locked (locked is true).
         */
        std::string FontDescription::fontPosture()         ;
        void FontDescription::fontPosture(std::string value)       ;
         ...
         * @throws  IllegalOperationError If set after the FontDescription object is locked (locked is true).
         */
        std::string FontDescription::fontWeight()         ;
        void FontDescription::fontWeight(std::string value)       ;
         ...
         * @throws  IllegalOperationError If set after the FontDescription object is locked (locked is true).
         */
        std::string FontDescription::cffHinting()         ;
        void FontDescription::cffHinting(std::string value)       ;
         ...
         * @throws  IllegalOperationError If set after the FontDescription object is locked (locked is true).
         */
        bool FontDescription::locked()          ;
        void FontDescription::locked(bool value)       ;
         ...
         */
        FontDescription::FontDescription(std::string fontName, std::string fontWeight, std::string fontPosture, std::string fontLookup, std::string renderingMode, std::string cffHinting);
         ...
         * @throws  ArgumentError The fontPosture specified is not a member of FontPosture.
         */
        bool FontDescription::isFontCompatible(std::string fontName, std::string fontWeight, std::string fontPosture)          ;
         ...
         * @throws  ArgumentError The fontPosture specified is not a member of FontPosture.
         */
        bool FontDescription::isDeviceFontCompatible(std::string fontName, std::string fontWeight, std::string fontPosture)          ;
         ...
         * @playerversion   Lite 4
         */
        flash::text::engine::FontDescription* FontDescription::clone()                                    ;
}
}
}
