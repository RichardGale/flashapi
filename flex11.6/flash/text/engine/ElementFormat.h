#if !defined(FLEX11_6_FLASH_TEXT_ENGINE_ELEMENTFORMAT_AS)
#define FLEX11_6_FLASH_TEXT_ENGINE_ELEMENTFORMAT_AS
    ...
    namespace text
    {
        namespace engine
        {
            ...
            public:
                 ...
                 */
            public:
                flash::text::engine::FontDescription *fontDescription();
            public:
                void         fontDescription(FontDescription *value);
            ...
            public:
                 ...
                 */
            public:
                flash::text::engine::FontMetrics *getFontMetrics();
                 ...
                 */
            public:
                flash::text::engine::ElementFormat *clone();
            };
        }
    }
}

#endif // FLEX11_6_FLASH_TEXT_ENGINE_ELEMENTFORMAT_AS
#endif // __cplusplus
