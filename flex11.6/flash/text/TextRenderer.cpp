...
namespace text {
        ...
        std::string TextRenderer::antiAliasType()         ;
        void TextRenderer::antiAliasType(std::string value)       ;
         ...
         *   </listing>
         */
        int TextRenderer::maxLevel()      ;
        void TextRenderer::maxLevel(int value)       ;
         ...
         * @playerversion   Flash 9
         */
        std::string TextRenderer::displayMode()         ;
        void TextRenderer::displayMode(std::string value)       ;
         ...
         *   </listing>
         */
        void TextRenderer::setAdvancedAntiAliasingTable(std::string fontName, std::string fontStyle, std::string colorType, std::vector<void*> advancedAntiAliasingTable)       ;
