...
#include "flash/text/StyleSheet.h"
...
namespace text {
         ...
         */
        bool TextField::alwaysShowSelection()          ;
        void TextField::alwaysShowSelection(bool value)       ;
         ...
         *   </listing>
         */
        std::string TextField::antiAliasType()         ;
        void TextField::antiAliasType(std::string antiAliasType)       ;
         ...
         * @playerversion   Lite 4
         */
        bool TextField::background()          ;
        void TextField::background(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int TextField::backgroundColor()       ;
        void TextField::backgroundColor(unsigned int value)       ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int TextField::borderColor()       ;
        void TextField::borderColor(unsigned int value)       ;
         ...
         * @playerversion   Lite 4
         */
        bool TextField::condenseWhite()          ;
        void TextField::condenseWhite(bool value)       ;
         ...
         */
        flash::text::TextFormat* TextField::defaultTextFormat()                        ;
        void TextField::defaultTextFormat(TextFormat* format)       ;
         ...
         * @playerversion   Lite 4
         */
        bool TextField::embedFonts()          ;
        void TextField::embedFonts(bool value)       ;
         ...
         *   </listing>
         */
        std::string TextField::gridFitType()         ;
        void TextField::gridFitType(std::string gridFitType)       ;
         ...
         * @playerversion   Lite 4
         */
        std::string TextField::htmlText()         ;
        void TextField::htmlText(std::string value)       ;
         ...
         * @playerversion   Lite 4
         */
        std::string TextField::textInteractionMode()         ;
         ...
         * @playerversion   Lite 4
         */
        int TextField::maxChars()      ;
        void TextField::maxChars(int value)       ;
         ...
         * @playerversion   Flash 9
         */
        bool TextField::mouseWheelEnabled()          ;
        void TextField::mouseWheelEnabled(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        bool TextField::multiline()          ;
        void TextField::multiline(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        bool TextField::displayAsPassword()          ;
        void TextField::displayAsPassword(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        std::string TextField::restrict()         ;
        void TextField::restrict(std::string value)       ;
         ...
         * @playerversion   Lite 4
         */
        int TextField::scrollH()      ;
        void TextField::scrollH(int value)       ;
         ...
         * @playerversion   Lite 4
         */
        int TextField::scrollV()      ;
        void TextField::scrollV(int value)       ;
        ...
        void TextField::selectable(bool value)       ;

        std::string TextField::selectedText()         ;
         ...
         * @playerversion   Lite 4
         */
        int TextField::selectionBeginIndex()      ;
         ...
         * @playerversion   Lite 4
         */
        int TextField::selectionEndIndex()      ;
         ...
         *   </listing>
         */
        float TextField::sharpness()         ;
        void TextField::sharpness(float value)       ;
        ...
        void TextField::styleSheet(StyleSheet* value)       ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int TextField::textColor()       ;
        void TextField::textColor(unsigned int value)       ;
         ...
         *   </listing>
         */
        float TextField::thickness()         ;
        void TextField::thickness(float value)       ;
         ...
         */
        std::string TextField::type()         ;
        void TextField::type(std::string value)       ;
         ...
         * @playerversion   Lite 4
         */
        bool TextField::wordWrap()          ;
        void TextField::wordWrap(bool value)       ;
         ...
         * @playerversion   Flash 9
         */
        bool TextField::useRichTextClipboard()          ;
        void TextField::useRichTextClipboard(bool value)       ;
         ...
         */
        bool TextField::isFontCompatible(std::string fontName, std::string fontStyle)          ;
         ...
         * @playerversion   Lite 4
         */
        void TextField::appendText(std::string newText)       ;std::string TextField::copyRichText()         ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Rectangle* TextField::getCharBoundaries(int charIndex)                       ;
         ...
         * @playerversion   Lite 4
         */
        int TextField::getCharIndexAtPoint(float x, float y)      ;
         ...
         * @playerversion   Lite 4
         */
        int TextField::getLineIndexAtPoint(float x, float y)      ;
         ...
         * @throws  RangeError The line number specified is out of range.
         */
        flash::text::TextLineMetrics* TextField::getLineMetrics(int lineIndex)                             ;
         ...
         * @throws  RangeError The line number specified is out of range.
         */
        int TextField::getLineOffset(int lineIndex)      ;
         ...
         * @throws  RangeError The line number specified is out of range.
         */
        std::string TextField::getLineText(int lineIndex)         ;
         ...
         * @throws  RangeError The character index specified is out of range.
         */
        int TextField::getParagraphLength(int charIndex)      ;
         ...
         */
        flash::text::TextFormat* TextField::getTextFormat(int beginIndex, int endIndex)                        ;

        std::vector<void*> TextField::getTextRuns(int beginIndex, int endIndex)        ;

        std::string TextField::getRawText()         ;

        std::string TextField::getXMLText(int beginIndex, int endIndex)         ;

        void TextField::insertXMLText(int beginIndex, int endIndex, std::string richText, bool pasting)       ;bool TextField::pasteRichText(std::string richText)          ;
         ...
         * @throws  Error This method cannot be used on a text field with a style sheet.
         */
        void TextField::replaceSelectedText(std::string value)       ;
         ...
         * @throws  Error This method cannot be used on a text field with a style sheet.
         */
        void TextField::replaceText(int beginIndex, int endIndex, std::string newText)       ;
         ...
         * @throws  RangeError The beginIndex or endIndex specified is out of range.
         */
        void TextField::setTextFormat(TextFormat* format, int beginIndex, int endIndex)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::display::DisplayObject* TextField::getImageReference(std::string id)                              ;
}
}
