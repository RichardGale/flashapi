...
namespace text {
         ...
         * @playerversion   Flash 9
         */
        const std::string FontStyle::REGULAR="regular";
         ...
         * @playerversion   Flash 9
         */
        const std::string FontStyle::BOLD="bold";
         ...
         * @playerversion   Flash 9
         */
        const std::string FontStyle::ITALIC="italic";
         ...
         * @playerversion   Flash 9
         */
        const std::string FontStyle::BOLD_ITALIC="boldItalic";
