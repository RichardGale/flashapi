...
namespace text {
         ...
         * @playerversion   Lite 4
         */
        int TextSnapshot::findText(int beginIndex, std::string textToFind, bool caseSensitive)      ;
         ...
         * @playerversion   Lite 4
         */
        bool TextSnapshot::getSelected(int beginIndex, int endIndex)          ;
         ...
         * @playerversion   Lite 4
         */
        std::string TextSnapshot::getSelectedText(bool includeLineEndings)         ;
         ...
         * @playerversion   Lite 4
         */
        std::string TextSnapshot::getText(int beginIndex, int endIndex, bool includeLineEndings)         ;
         ...
         * @playerversion   Lite 4
         */
        std::vector<void*> TextSnapshot::getTextRunInfo(int beginIndex, int endIndex)        ;
         ...
         * @playerversion   Lite 4
         */
        float TextSnapshot::hitTestTextNearPos(float x, float y, float maxDistance)         ;
         ...
         * @playerversion   Lite 4
         */
        void TextSnapshot::setSelectColor(unsigned int hexColor)       ;
         ...
         * @playerversion   Lite 4
         */
        void TextSnapshot::setSelected(int beginIndex, int endIndex, bool select)       ;
