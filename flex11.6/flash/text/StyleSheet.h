#if !defined(FLEX11_6_FLASH_TEXT_STYLESHEET_AS)
#define FLEX11_6_FLASH_TEXT_STYLESHEET_AS
...
namespace flash
{
    namespace text
    {
        ...
        public:
             ...
             */
        public:
            void     setStyle(std::string styleName, Object *styleObject);
        ...
        public:
             ...
             */
        public:
            flash::text::TextFormat *transform(Object *formatObject);
             ...
             */
        public:
            void     parseCSS(std::string CSSText);
        };
    }
}

#endif // FLEX11_6_FLASH_TEXT_STYLESHEET_AS
#endif // __cplusplus
