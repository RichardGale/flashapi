...
namespace external {
         ...
         * @playerversion   Lite 4
         */
        bool ExternalInterface::available()          ;
         ...
         * @playerversion   Lite 4
         */
        std::string ExternalInterface::objectID()         ;
         ...
         */
        void ExternalInterface::addCallback(std::string functionName, Function* closure)       ;
         ...
         *     flash.system.Security.allowDomain(sourceDomain)
         */
        void* ExternalInterface::call(std::string functionName, ...)    ;
}
}
