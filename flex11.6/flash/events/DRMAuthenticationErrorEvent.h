...
namespace flash
{
    namespace events
    {
        ...
        public:
             ...
             */
        public:
            DRMAuthenticationErrorEvent(std::string type, bool bubbles, bool cancelable, std::string inDetail, int inErrorID, int inSubErrorID, std::string inServerURL, std::string inDomain);
        };
    }
}
