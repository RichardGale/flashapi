...
namespace events {
         ...
         * @playerversion   Lite 4
         */
        flash::events::Event* NetStatusEvent::clone()                     ;
         ...
         * @playerversion   Lite 4
         */
        NetStatusEvent::NetStatusEvent(std::string type, bool bubbles, bool cancelable, Object* info);
         ...
         * @playerversion   Lite 4
         */
        std::string NetStatusEvent::toString()         ;
}
}
