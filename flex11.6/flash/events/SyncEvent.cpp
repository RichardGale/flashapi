...
namespace events {
         ...
         * @playerversion   Lite 4
         */
        std::vector<void*> SyncEvent::changeList()        ;
        void SyncEvent::changeList(std::vector<void*> value)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::events::Event* SyncEvent::clone()                     ;
         ...
         * @playerversion   Lite 4
         */
        SyncEvent::SyncEvent(std::string type, bool bubbles, bool cancelable, std::vector<void*> changeList);
