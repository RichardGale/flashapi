...
namespace events {
         ...
         * @playerversion   AIR 2.7
         */
        flash::net::NetStream* NetMonitorEvent::netStream()                      ;
         ...
         * @playerversion   AIR 2.7
         */
        flash::events::Event* NetMonitorEvent::clone()                     ;
         ...
         * @playerversion   AIR 2.7
         */
        NetMonitorEvent::NetMonitorEvent(std::string type, bool bubbles, bool cancelable, NetStream* netStream);
         ...
         * @playerversion   AIR 2.7
         */
        std::string NetMonitorEvent::toString()         ;
}
}
