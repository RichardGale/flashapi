...
namespace events {
         ...
         * @playerversion   AIR (unsupported)
         */
        std::string StageVideoAvailabilityEvent::availability()         ;
         ...
         * @playerversion   AIR (unsupported)
         */
        StageVideoAvailabilityEvent::StageVideoAvailabilityEvent(std::string type, bool bubbles, bool cancelable, std::string availability);
}
}
