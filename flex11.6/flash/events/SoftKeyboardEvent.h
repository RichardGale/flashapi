#if !defined(FLEX11_6_FLASH_EVENTS_SOFTKEYBOARDEVENT_AS)
#define FLEX11_6_FLASH_EVENTS_SOFTKEYBOARDEVENT_AS
...
namespace flash
{
    namespace events
    {
        class SoftKeyboardEvent: public Event
        {
             ...
             */
        public:
            static const std::string SOFT_KEYBOARD_ACTIVATE;
             ...
             */
        public:
            static const std::string SOFT_KEYBOARD_DEACTIVATE;
             ...
             */
        public:
            static const std::string SOFT_KEYBOARD_ACTIVATING;
        ...
        public:
             ...
             */
        public:
            SoftKeyboardEvent(std::string type, bool bubbles, bool cancelable, InteractiveObject *relatedObjectVal, std::string triggerTypeVal);
...
#endif // FLEX11_6_FLASH_EVENTS_SOFTKEYBOARDEVENT_AS
#endif // __cplusplus
