#if !defined(FLEX11_6_FLASH_EVENTS_NETSTATUSEVENT_AS)
#define FLEX11_6_FLASH_EVENTS_NETSTATUSEVENT_AS
...
namespace flash
{
    namespace events
    {
        ...
        class NetStatusEvent : public flash::events::Event
        {
             ...
             */
        public:
            static const std::string NET_STATUS;
...
#endif // FLEX11_6_FLASH_EVENTS_NETSTATUSEVENT_AS
#endif // __cplusplus
