...
//[Event(name="outputData",type="flash.events.ProgressEvent")]/// @eventType  flash.events.ProgressEvent.STANDARD_OUTPUT_DATA
...
namespace flash
{
    namespace events
    {
        ...
        public:
             ...
             */
        public:
            ProgressEvent(std::string type, bool bubbles, bool cancelable, float bytesLoaded, float bytesTotal);
