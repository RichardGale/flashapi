...
//[Event(name="rollOver",type="flash.events.MouseEvent")]/// @eventType  flash.events.MouseEvent.ROLL_OVER
...
namespace flash
{
    namespace events
    {
        ...
        public:
             ...
             */
        public:
            MouseEvent(std::string type, bool bubbles, bool cancelable, float localX, float localY, InteractiveObject *relatedObject, bool ctrlKey, bool altKey, bool shiftKey, bool buttonDown, int delta);
