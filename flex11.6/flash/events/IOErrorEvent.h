...
//[Event(name="IOErrorEvent",type="flash.events.IOErrorEvent")]/// @eventType  flash.events.IOErrorEvent.STANDARD_OUTPUT_IO_ERROR
...
namespace flash
{
    namespace events
    {
        ...
        public:
             ...
             */
        public:
            IOErrorEvent(std::string type, bool bubbles, bool cancelable, std::string text, int id);
