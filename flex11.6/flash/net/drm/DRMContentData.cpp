...
#include "DRMContentData.h"
#include "flash/utils/ByteArray.h"
#include "flash/net/drm/VoucherAccessInfo.h"
...
namespace drm {
         ...
         * @playerversion   Flash 10.1
         */
        std::string DRMContentData::serverURL()         ;
         ...
         * @playerversion   Flash 10.1
         */
        std::string DRMContentData::authenticationMethod()         ;
         ...
         * @playerversion   Flash 10.1
         */
        std::string DRMContentData::licenseID()         ;
         ...
         * @playerversion   Flash 10.1
         */
        std::string DRMContentData::domain()         ;
         ...
         * @playerversion   Flash 10.1
         */
        DRMContentData::DRMContentData(ByteArray* rawData);
         ...
         * @playerversion   Flash 10.1
         */
        std::vector<flash::net::drm::VoucherAccessInfo*> DRMContentData::getVoucherAccessInfo()                                           ;
}
}
}
