...
namespace drm {
         ...
         * @playerversion   Flash 10.1
         */
        std::string VoucherAccessInfo::displayName()         ;
         ...
         * @playerversion   Flash 10.1
         */
        std::string VoucherAccessInfo::authenticationMethod()         ;
         ...
         * @playerversion   Flash 10.1
         */
        std::string VoucherAccessInfo::domain()         ;

        VoucherAccessInfo::VoucherAccessInfo();
}
}
}
