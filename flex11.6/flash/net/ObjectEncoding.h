#if !defined(FLEX11_6_FLASH_NET_OBJECTENCODING_AS)
#define FLEX11_6_FLASH_NET_OBJECTENCODING_AS
...
namespace flash
{
    namespace net
    {
        class ObjectEncoding: public Object
        {
             ...
             */
        public:
            static const unsigned int AMF0;
             ...
             */
        public:
            static const unsigned int AMF3;
        ...
        public:
             ...
             */
        public:
            static flash::net::IDynamicPropertyWriter *dynamicPropertyWriter();
        public:
            static void         dynamicPropertyWriter(IDynamicPropertyWriter *object);
...
#endif // FLEX11_6_FLASH_NET_OBJECTENCODING_AS
#endif // __cplusplus
