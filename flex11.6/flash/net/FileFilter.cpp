...
namespace net {
         ...
         * @playerversion   Flash 9
         */
        std::string FileFilter::description()         ;
        void FileFilter::description(std::string value)       ;
         ...
         * @playerversion   Flash 9
         */
        std::string FileFilter::extension()         ;
        void FileFilter::extension(std::string value)       ;
         ...
         * @playerversion   Flash 9
         */
        std::string FileFilter::macType()         ;
        void FileFilter::macType(std::string value)       ;
         ...
         * @playerversion   Flash 9
         */
        FileFilter::FileFilter(std::string description, std::string extension, std::string macType);
}
}
