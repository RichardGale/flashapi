#if !defined(FLEX11_6_FLASH_NET_NETCONNECTION_AS)
#define FLEX11_6_FLASH_NET_NETCONNECTION_AS
...
namespace flash
{
    namespace net
    {
        ...
        public:
             ...
             */
        public:
            void     addHeader(std::string operation, bool mustUnderstand, Object *param);
             ...
             */
        public:
            void     call(std::string command, Responder *responder, ...);
             ...
             */
        public:
            void     connect(std::string command, ...);
        };
    }
}

#endif // FLEX11_6_FLASH_NET_NETCONNECTION_AS
#endif // __cplusplus
