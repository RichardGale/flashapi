...
namespace net {
         ...
         * @playerversion   Lite 4
         */
        unsigned int URLStream::bytesAvailable()       ;
         ...
         */
        unsigned int URLStream::objectEncoding()       ;
        void URLStream::objectEncoding(unsigned int version)       ;
         ...
         * @playerversion   Lite 4
         */
        std::string URLStream::endian()         ;
        void URLStream::endian(std::string type)       ;

        bool URLStream::diskCacheEnabled()          ;

        float URLStream::position()         ;
        void URLStream::position(float offset)       ;

        float URLStream::length()         ;
         ...
         */
        void URLStream::load(URLRequest* request)       ;
         ...
         */
        void URLStream::readBytes(ByteArray* bytes, unsigned int offset, unsigned int length)       ;
         ...
         *   or the stream is not open.
         */
        unsigned int URLStream::readUnsignedByte()       ;
         ...
         *   or the stream is not open.
         */
        unsigned int URLStream::readUnsignedShort()       ;
         ...
         *   or the stream is not open.
         */
        unsigned int URLStream::readUnsignedInt()       ;
         ...
         *   received, and any of the read methods throws an EOFError exception.
         */
        std::string URLStream::readMultiByte(unsigned int length, std::string charSet)         ;
         ...
         *   or the stream is not open.
         */
        std::string URLStream::readUTFBytes(unsigned int length)         ;
