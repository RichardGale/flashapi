...
#include "flash/net/NetStreamPlayOptions.h"
#include "flash/net/NetStreamInfo.h"
#include "flash/net/NetStreamMulticastInfo.h"
#include "flash/media/SoundTransform.h"
#include "flash/utils/ByteArray.h"
#include "flash/media/VideoStreamSettings.h"
...
namespace net {
         ...
         * @playerversion   Lite 4
         */
        float NetStream::bufferTime()         ;
        void NetStream::bufferTime(float bufferTime)       ;
         ...
         * @playerversion   Lite 4
         */
        float NetStream::maxPauseBufferTime()         ;
        void NetStream::maxPauseBufferTime(float pauseBufferTime)       ;
         ...
         * @playerversion   AIR 2
         */
        float NetStream::backBufferTime()         ;
        void NetStream::backBufferTime(float backBufferTime)       ;
         ...
         */
        bool NetStream::inBufferSeek()          ;
        void NetStream::inBufferSeek(bool value)       ;
         ...
         * @playerversion   AIR 2
         */
        float NetStream::backBufferLength()         ;
         ...
         * @playerversion   AIR 2
         */
        float NetStream::bufferTimeMax()         ;
        void NetStream::bufferTimeMax(float bufferTimeMax)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::net::NetStreamInfo* NetStream::info()                          ;
         ...
         * @playerversion   AIR 2
         */
        flash::net::NetStreamMulticastInfo* NetStream::multicastInfo()                                   ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int NetStream::bytesLoaded()       ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int NetStream::bytesTotal()       ;

        unsigned int NetStream::decodedFrames()       ;

        unsigned int NetStream::videoCodec()       ;

        unsigned int NetStream::audioCodec()       ;
         ...
         * @playerversion   Flash 9
         */
        flash::media::SoundTransform* NetStream::soundTransform()                             ;
        void NetStream::soundTransform(SoundTransform* sndTransform)       ;
         ...
         */
        bool NetStream::checkPolicyFile()          ;
        void NetStream::checkPolicyFile(bool state)       ;
         ...
         */
        Object* NetStream::client()         ;
        void NetStream::client(Object* object)       ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int NetStream::objectEncoding()       ;
         ...
         * @playerversion   AIR 2
         */
        float NetStream::multicastPushNeighborLimit()         ;
        void NetStream::multicastPushNeighborLimit(float neighbors)       ;
         ...
         * @playerversion   AIR 2
         */
        float NetStream::multicastWindowDuration()         ;
        void NetStream::multicastWindowDuration(float seconds)       ;
         ...
         * @playerversion   AIR 2
         */
        float NetStream::multicastRelayMarginDuration()         ;
        void NetStream::multicastRelayMarginDuration(float seconds)       ;
         ...
         * @playerversion   AIR 2
         */
        float NetStream::multicastAvailabilityUpdatePeriod()         ;
        void NetStream::multicastAvailabilityUpdatePeriod(float seconds)       ;
         ...
         * @playerversion   AIR 2
         */
        float NetStream::multicastFetchPeriod()         ;
        void NetStream::multicastFetchPeriod(float seconds)       ;
         ...
         * @playerversion   AIR 2
         */
        bool NetStream::multicastAvailabilitySendToAll()          ;
        void NetStream::multicastAvailabilitySendToAll(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        std::string NetStream::nearNonce()         ;
         ...
         * @playerversion   AIR 1.5
         */
        std::vector<void*> NetStream::peerStreams()        ;
         ...
         * @playerversion   AIR 2
         */
        bool NetStream::audioReliable()          ;
        void NetStream::audioReliable(bool reliable)       ;
         ...
         * @playerversion   AIR 2
         */
        bool NetStream::videoReliable()          ;
        void NetStream::videoReliable(bool reliable)       ;
         ...
         * @playerversion   AIR 2
         */
        bool NetStream::dataReliable()          ;
        void NetStream::dataReliable(bool reliable)       ;
         ...
         * @playerversion   AIR 2
         */
        bool NetStream::audioSampleAccess()          ;
        void NetStream::audioSampleAccess(bool reliable)       ;
         ...
         * @playerversion   AIR 2
         */
        bool NetStream::videoSampleAccess()          ;
        void NetStream::videoSampleAccess(bool reliable)       ;

        bool NetStream::useHardwareDecoder()          ;
        void NetStream::useHardwareDecoder(bool v)       ;

        bool NetStream::useJitterBuffer()          ;
        void NetStream::useJitterBuffer(bool value)       ;

        VideoStreamSettings* NetStream::videoStreamSettings()                      ;
        void NetStream::videoStreamSettings(VideoStreamSettings* settings)       ;

        void NetStream::dispose()       ;
         ...
         * @playerversion   Flash 9
         */
        void NetStream::attachAudio(Microphone* microphone)       ;
         ...
         * @playerversion   Flash 9
         */
        void NetStream::attachCamera(Camera* theCamera, int snapshotMilliseconds)       ;
         ...
         */
        NetStream::NetStream(NetConnection* connection, std::string peerID);
         ...
         * @playerversion   Flash 9
         */
        void NetStream::send(std::string handlerName, ...)       ;
         ...
         * @playerversion   AIR 2
         */
        void NetStream::step(int frames)       ;
         ...
         * @playerversion   Lite 4
         */
        void NetStream::receiveAudio(bool flag)       ;
         ...
         * @playerversion   Lite 4
         */
        void NetStream::receiveVideo(bool flag)       ;
         ...
         * @playerversion   Lite 4
         */
        void NetStream::receiveVideoFPS(float FPS)       ;
         ...
         * @playerversion   Lite 4
         */
        void NetStream::seek(float offset)       ;
         ...
         * @playerversion   Lite 4
         */
        void NetStream::play2(NetStreamPlayOptions* param)       ;
         ...
         * @playerversion   Flash 9
         */
        void NetStream::publish(std::string name, std::string type)       ;
         ...
         * @playerversion   Lite 4
         */
        bool NetStream::onPeerConnect(NetStream* subscriber)          ;
         ...
         * @playerversion   AIR 2
         */
        void NetStream::appendBytes(ByteArray* bytes)       ;
         ...
         * @playerversion   AIR 2
         */
        void NetStream::appendBytesAction(std::string netStreamAppendBytesAction)       ;
}
}
