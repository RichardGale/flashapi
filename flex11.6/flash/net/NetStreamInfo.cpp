...
namespace net {
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::currentBytesPerSecond()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::maxBytesPerSecond()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::audioBytesPerSecond()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::audioByteCount()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::videoBytesPerSecond()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::videoByteCount()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::dataBytesPerSecond()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::dataByteCount()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::playbackBytesPerSecond()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::droppedFrames()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::audioBufferByteLength()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::videoBufferByteLength()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::dataBufferByteLength()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::audioBufferLength()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::videoBufferLength()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::dataBufferLength()         ;
         ...
         * @playerversion   Lite 4
         */
        float NetStreamInfo::audioLossRate()         ;
         ...
         * @playerversion   AIR 2
         */
        float NetStreamInfo::videoLossRate()         ;
         ...
         * @playerversion   AIR 2.7
         */
        std::string NetStreamInfo::resourceName()         ;
         ...
         * @playerversion   AIR 2.7
         */
        bool NetStreamInfo::isLive()          ;

        NetStreamInfo::NetStreamInfo(float curBPS, float byteCount, float maxBPS, float audioBPS, float audioByteCount, float videoBPS, float videoByteCount, float dataBPS, float dataByteCount, float playbackBPS, float droppedFrames, float audioBufferByteLength, float videoBufferByteLength, float dataBufferByteLength, float audioBufferLength, float videoBufferLength, float dataBufferLength, float srtt, float audioLossRate, float videoLossRate, Object* metaData, Object* xmpData, std::string uri, std::string resourceName, bool isLive);
         ...
         * @playerversion   Lite 4
         */
        std::string NetStreamInfo::toString()         ;
}
}
