...
namespace net {
        ...
        void URLRequest::url(std::string value)       ;
         ...
         * @playerversion   Lite 4
         */
        Object* URLRequest::data()         ;
        void URLRequest::data(Object* value)       ;
         ...
         */
        std::string URLRequest::method()         ;
        void URLRequest::method(std::string value)       ;
        ...
        void URLRequest::contentType(std::string value)       ;
         ...
         * @playerversion   Lite 4
         */
        std::vector<void*> URLRequest::requestHeaders()        ;
        void URLRequest::requestHeaders(std::vector<void*> value)       ;
         ...
         */
        std::string URLRequest::digest()         ;
        void URLRequest::digest(std::string value)       ;
