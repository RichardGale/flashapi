...
namespace net {
         ...
         */
        Date* FileReference::creationDate()       ;
         ...
         *   is null.
         */
        std::string FileReference::creator()         ;
         ...
         *   indicating a file I/O error.
         */
        Date* FileReference::modificationDate()       ;
         ...
         */
        flash::utils::ByteArray* FileReference::data()                        ;
         ...
         */
        void FileReference::download(URLRequest* request, std::string defaultFileName)       ;
         ...
         *   to perform a POST operation.
         */
        void FileReference::upload(URLRequest* request, std::string uploadDataFieldName, bool testUpload)       ;
         ...
         *   The file may be too large or available memory may be too low.
         */
        void FileReference::save(void* data, std::string defaultFileName)       ;
         ...
         *   event or keypress event.
         */
        bool FileReference::browse(std::vector<void*> typeFilter)          ;
}
}
