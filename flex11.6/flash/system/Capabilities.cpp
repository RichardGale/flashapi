...
namespace system {
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::isEmbeddedInAcrobat()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::hasEmbeddedVideo()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::avHardwareDisable()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::hasAccessibility()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::hasAudioEncoder()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::hasScreenBroadcast()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::hasScreenPlayback()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::hasStreamingAudio()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::hasStreamingVideo()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::hasVideoEncoder()          ;
         ...
         * @playerversion   Lite 4
         */
        bool Capabilities::localFileReadDisable()          ;
         ...
         * @playerversion   Lite 4
         */
        std::string Capabilities::language()         ;
         ...
         * @playerversion   Lite 4
         */
        std::string Capabilities::manufacturer()         ;
         ...
         *   </pre>
         */
        std::string Capabilities::cpuArchitecture()         ;
         ...
         * @playerversion   Lite 4
         */
        std::string Capabilities::playerType()         ;
         ...
         * @playerversion   Lite 4
         */
        std::string Capabilities::serverString()         ;
         ...
         * @playerversion   Lite 4
         */
        std::string Capabilities::version()         ;
         ...
         * @playerversion   Lite 4
         */
        std::string Capabilities::screenColor()         ;
         ...
         * @playerversion   Lite 4
         */
        float Capabilities::pixelAspectRatio()         ;
         ...
         * @playerversion   Lite 4
         */
        float Capabilities::screenResolutionX()         ;
         ...
         * @playerversion   Lite 4
         */
        float Capabilities::screenResolutionY()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string Capabilities::touchscreenType()         ;
         ...
         * @playerversion   Lite 4
         */
        std::string Capabilities::maxLevelIDC()         ;
         ...
         *   </pre>
         */
        bool Capabilities::supports32BitProcesses()          ;
         ...
         *   </pre>
         */
        bool Capabilities::supports64BitProcesses()          ;

        unsigned int Capabilities::_internal()       ;

        Capabilities::Capabilities();

        bool Capabilities::hasMultiChannelAudio(std::string type)          ;
}
}
