...
namespace system {
         ...
         * @playerversion   Lite 4
         */
        unsigned int System::totalMemory()       ;
         ...
         * @playerversion   AIR 2
         */
        float System::totalMemoryNumber()         ;
         ...
         * @playerversion   AIR 2
         */
        float System::privateMemory()         ;

        float System::processCPUUsage()         ;
         ...
         * @playerversion   Lite 4
         */
        bool System::useCodePage()          ;
        void System::useCodePage(bool value)       ;

        std::string System::vmVersion()         ;
         ...
         * @playerversion   Flash 9
         */
        void System::setClipboard(std::string string)       ;
         ...
         * @playerversion   Flash 9.0.115.0
         */
        void System::exit(unsigned int code)       ;
        ...
        void System::pauseForGCIfCollectionImminent(float imminence)       ;
         ...
         */
        void System::disposeXML(XML* node)       ;
}
}
