...
namespace system {
         ...
         * @playerversion   Lite 4
         */
        bool LoaderContext::allowLoadBytesCodeExecution()          ;
        void LoaderContext::allowLoadBytesCodeExecution(bool allow)       ;
         ...
         * @playerversion   Lite 4
         */
        LoaderContext::LoaderContext(bool checkPolicyFile, ApplicationDomain* applicationDomain, SecurityDomain* securityDomain);
}
}
