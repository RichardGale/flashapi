...
namespace system {
         ...
         * @playerversion   Lite 4
         */
        JPEGLoaderContext::JPEGLoaderContext(float deblockingFilter, bool checkPolicyFile, ApplicationDomain* applicationDomain, SecurityDomain* securityDomain);
}
}
