#if !defined(FLEX11_6_FLASH_SYSTEM_IME_AS)
#define FLEX11_6_FLASH_SYSTEM_IME_AS
...
namespace flash
{
    namespace system
    {
         ...
         */
        class IME : public flash::events::EventDispatcher
        {
            /**
        ...
        public:
             ...
             */
        public:
            static void     setCompositionString(std::string composition);
        ...
        public:
             ...
             */
        public:
            static void     compositionSelectionChanged(int start, int end);
             ...
             */
        public:
            static void     compositionAbandoned();
        };
    }
}

#endif // FLEX11_6_FLASH_SYSTEM_IME_AS
#endif // __cplusplus
