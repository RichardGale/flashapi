...
namespace system {
         ...
         */
        bool Security::exactSettings()          ;
        void Security::exactSettings(bool value)       ;

        bool Security::disableAVM1Loading()          ;
        void Security::disableAVM1Loading(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        std::string Security::sandboxType()         ;
         ...
         */
        std::string Security::pageDomain()         ;
         ...
         *   content in the application security sandbox.
         */
        void Security::allowInsecureDomain(...)       ;
         ...
         * @playerversion   Lite 4
         */
        void Security::loadPolicyFile(std::string url)       ;

        std::vector<void*> Security::duplicateSandboxBridgeInputArguments(Object* toplevel, std::vector<void*> args)        ;

        void* Security::duplicateSandboxBridgeOutputArgument(Object* toplevel, void* arg)    ;
         ...
         * @playerversion   Lite 4
         */
        void Security::showSettings(std::string panel)       ;
}
}
