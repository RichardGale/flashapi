...
namespace system {
         ...
         */
        flash::system::ApplicationDomain* ApplicationDomain::currentDomain()                                 ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int ApplicationDomain::MIN_DOMAIN_MEMORY_LENGTH()       ;
         ...
         * @playerversion   Lite 4
         */
        flash::system::ApplicationDomain* ApplicationDomain::parentDomain()                                 ;
         ...
         * @playerversion   Lite 4
         */
        flash::utils::ByteArray* ApplicationDomain::domainMemory()                        ;
        void ApplicationDomain::domainMemory(ByteArray* mem)       ;
         ...
         * @playerversion   Lite 4
         */
        ApplicationDomain::ApplicationDomain(ApplicationDomain* parentDomain);
         ...
         *   specified name.
         */
        Object* ApplicationDomain::getDefinition(std::string name)         ;
         ...
         * @playerversion   Lite 4
         */
        bool ApplicationDomain::hasDefinition(std::string name)          ;

        std::vector<std::string> ApplicationDomain::getQualifiedDefinitionNames()                  ;
}
}
