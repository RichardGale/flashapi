...
#include "Clipboard.h"
#include "flash/desktop/Clipboard.h"
...
namespace desktop {
         ...
         * @playerversion   AIR 1.0
         */
        flash::desktop::Clipboard* Clipboard::generalClipboard()                          ;
         ...
         * @playerversion   AIR 1.0
         */
        std::vector<void*> Clipboard::formats()        ;
         ...
         *   application security sandbox.
         */
        void Clipboard::clearData(std::string format)       ;
         ...
         */
        bool Clipboard::setData(std::string format, Object* data, bool serializable)          ;
         ...
         *   application security sandbox.
         */
        bool Clipboard::setDataHandler(std::string format, Function* handler, bool serializable)          ;
         ...
         */
        Object* Clipboard::getData(std::string format, std::string transferMode)         ;
         ...
         * @throws  SecurityError Reading from or writing to the clipboard is not permitted in this context.
         */
        bool Clipboard::hasFormat(std::string format)          ;
}
}
