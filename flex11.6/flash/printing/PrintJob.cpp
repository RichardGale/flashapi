...
#include "flash/printing/PrintJobOptions.h"
...
namespace printing {
         ...
         */
        std::string PrintJob::orientation()         ;
         ...
         */
        void PrintJob::addPage(Sprite* sprite, Rectangle* printArea, PrintJobOptions* options, int frameNum)       ;
}
}
