...
#include "AccessibilityImplementation.h"
...
namespace accessibility {
         ...
         */
        unsigned int AccessibilityImplementation::get_accRole(unsigned int childID)       ;
         ...
         * @playerversion   AIR 2
         */
        std::string AccessibilityImplementation::get_accName(unsigned int childID)         ;
         ...
         * @playerversion   AIR 2
         */
        std::string AccessibilityImplementation::get_accValue(unsigned int childID)         ;
         ...
         */
        unsigned int AccessibilityImplementation::get_accState(unsigned int childID)       ;
         ...
         * @playerversion   AIR 2
         */
        std::string AccessibilityImplementation::get_accDefaultAction(unsigned int childID)         ;
         ...
         * @playerversion   AIR 2
         */
        void AccessibilityImplementation::accDoDefaultAction(unsigned int childID)       ;
         ...
         * @playerversion   AIR 2
         */
        bool AccessibilityImplementation::isLabeledBy(Rectangle* labelBounds)          ;
         ...
         * @playerversion   AIR 2
         */
        std::vector<void*> AccessibilityImplementation::getChildIDArray()        ;
         ...
         * @playerversion   AIR 2
         */
        void* AccessibilityImplementation::accLocation(unsigned int childID)    ;
         ...
         * @playerversion   AIR 2
         */
        std::vector<void*> AccessibilityImplementation::get_accSelection()        ;
         ...
         * @playerversion   AIR 2
         */
        unsigned int AccessibilityImplementation::get_accFocus()       ;
         ...
         * @playerversion   AIR 2
         */
        void AccessibilityImplementation::accSelect(unsigned int operation, unsigned int childID)       ;

        void* AccessibilityImplementation::get_selectionAnchorIndex()    ;

        void* AccessibilityImplementation::get_selectionActiveIndex()    ;
}
}
