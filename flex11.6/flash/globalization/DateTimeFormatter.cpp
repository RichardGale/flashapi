...
namespace globalization {
         ...
         * @playerversion   AIR 2
         */
        std::string DateTimeFormatter::lastOperationStatus()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string DateTimeFormatter::requestedLocaleIDName()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string DateTimeFormatter::actualLocaleIDName()         ;
         ...
         */
        DateTimeFormatter::DateTimeFormatter(std::string requestedLocaleIDName, std::string dateStyle, std::string timeStyle);
         ...
         * @playerversion   AIR 2
         */
        std::vector<std::string> DateTimeFormatter::getAvailableLocaleIDNames()                  ;
         ...
         * @throws  TypeError if the dateStyle or timeStyle parameter is null.
         */
        void DateTimeFormatter::setDateTimeStyles(std::string dateStyle, std::string timeStyle)       ;
         ...
         * @playerversion   AIR 2
         */
        std::string DateTimeFormatter::getTimeStyle()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string DateTimeFormatter::getDateStyle()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string DateTimeFormatter::format(Date* dateTime)         ;
         ...
         * @playerversion   AIR 2
         */
        std::string DateTimeFormatter::formatUTC(Date* dateTime)         ;
         ...
         */
        std::vector<std::string> DateTimeFormatter::getMonthNames(std::string nameStyle, std::string context)                  ;
         ...
         * @throws  TypeError if the nameStyle or context parameter is null.
         */
        std::vector<std::string> DateTimeFormatter::getWeekdayNames(std::string nameStyle, std::string context)                  ;
         ...
         * @playerversion   AIR 2
         */
        int DateTimeFormatter::getFirstWeekday()      ;
         ...
         * @playerversion   AIR 2
         */
        std::string DateTimeFormatter::getDateTimePattern()         ;
         ...
         */
        void DateTimeFormatter::setDateTimePattern(std::string pattern)       ;
}
}
