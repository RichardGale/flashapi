...
#include "flash/globalization/CurrencyParseResult.h"
...
namespace globalization {
         ...
         * @playerversion   AIR 2
         */
        std::string CurrencyFormatter::currencyISOCode()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string CurrencyFormatter::currencySymbol()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string CurrencyFormatter::lastOperationStatus()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string CurrencyFormatter::requestedLocaleIDName()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string CurrencyFormatter::actualLocaleIDName()         ;
         ...
         * @playerversion   AIR 2
         */
        int CurrencyFormatter::fractionalDigits()      ;
        void CurrencyFormatter::fractionalDigits(int value)       ;
         ...
         * @playerversion   AIR 2
         */
        bool CurrencyFormatter::useGrouping()          ;
        void CurrencyFormatter::useGrouping(bool value)       ;
         ...
         */
        std::string CurrencyFormatter::groupingPattern()         ;
        void CurrencyFormatter::groupingPattern(std::string value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        unsigned int CurrencyFormatter::digitsType()       ;
        void CurrencyFormatter::digitsType(unsigned int value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        std::string CurrencyFormatter::decimalSeparator()         ;
        void CurrencyFormatter::decimalSeparator(std::string value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        std::string CurrencyFormatter::groupingSeparator()         ;
        void CurrencyFormatter::groupingSeparator(std::string value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        std::string CurrencyFormatter::negativeSymbol()         ;
        void CurrencyFormatter::negativeSymbol(std::string value)       ;
         ...
         */
        unsigned int CurrencyFormatter::negativeCurrencyFormat()       ;
        void CurrencyFormatter::negativeCurrencyFormat(unsigned int value)       ;
         ...
         */
        unsigned int CurrencyFormatter::positiveCurrencyFormat()       ;
        void CurrencyFormatter::positiveCurrencyFormat(unsigned int value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        bool CurrencyFormatter::leadingZero()          ;
        void CurrencyFormatter::leadingZero(bool value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        bool CurrencyFormatter::trailingZeros()          ;
        void CurrencyFormatter::trailingZeros(bool value)       ;
         ...
         */
        CurrencyFormatter::CurrencyFormatter(std::string requestedLocaleIDName);
         ...
         * @playerversion   AIR 2
         */
        std::vector<std::string> CurrencyFormatter::getAvailableLocaleIDNames()                  ;
         ...
         */
        void CurrencyFormatter::setCurrency(std::string currencyISOCode, std::string currencySymbol)       ;
         ...
         * @playerversion   AIR 2
         */
        std::string CurrencyFormatter::format(float value, bool withCurrencySymbol)         ;
         ...
         */
        bool CurrencyFormatter::formattingWithCurrencySymbolIsSafe(std::string requestedISOCode)          ;
         ...
         */
        flash::globalization::CurrencyParseResult* CurrencyFormatter::parse(std::string inputString)                                          ;
}
}
