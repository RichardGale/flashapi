#if !defined(FLEX11_6_FLASH_GLOBALIZATION_NUMBERFORMATTER_AS)
#define FLEX11_6_FLASH_GLOBALIZATION_NUMBERFORMATTER_AS
...
namespace flash
{
    namespace globalization
    {
        ...
        public:
             ...
             */
        public:
            NumberFormatter(std::string requestedLocaleIDName);
             ...
             */
        public:
            flash::globalization::NumberParseResult *parse(std::string parseString);
...
#endif // FLEX11_6_FLASH_GLOBALIZATION_NUMBERFORMATTER_AS
#endif // __cplusplus
