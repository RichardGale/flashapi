...
namespace globalization {
         ...
         * @playerversion   AIR 2
         */
        std::string StringTools::lastOperationStatus()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string StringTools::requestedLocaleIDName()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string StringTools::actualLocaleIDName()         ;
         ...
         * @playerversion   AIR 2
         */
        std::vector<std::string> StringTools::getAvailableLocaleIDNames()                  ;
         ...
         */
        StringTools::StringTools(std::string requestedLocaleIDName);
         ...
         */
        std::string StringTools::toLowerCase(std::string s)         ;
         ...
         * @throws  ArgumentError when the s parameter is null.
         */
        std::string StringTools::toUpperCase(std::string s)         ;
}
}
