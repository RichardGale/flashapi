...
#include "flash/globalization/NumberParseResult.h"
     ...
     * 
     *   <p class="- topic/p ">This example uses the following locales: default operating system locale for number formatting, Japanese (Japan), English (US), and
     * French (France). The example uses the static member <codeph class="+ topic/ph pr-d/codeph ">LocaleID.DEFAULT</codeph> to request the default operating system locale.</p><p class="- topic/p ">
     ...
     * </p><ol class="- topic/ol "><li class="- topic/li ">Creates a NumberFormatter object.</li><li class="- topic/li ">Formats the same value as a Number, an integer, and an unsigned integer, and displays the results.</li></ol><codeblock xml:space="preserve" class="+ topic/pre pr-d/codeblock ">
     * 
     *   package {
     ...
     * </p><ol class="- topic/ol "><li class="- topic/li ">Creates a NumberFormatter object.</li><li class="- topic/li ">Calls the <codeph class="+ topic/ph pr-d/codeph ">NumberFormatter.parse()</codeph> method to parse the string and return a NumberParseResult object.</li><li class="- topic/li ">Calls the <codeph class="+ topic/ph pr-d/codeph ">NumberFormatter.parseNumber()</codeph> method to parse the string and return a Number value.</li></ol><codeblock xml:space="preserve" class="+ topic/pre pr-d/codeblock ">
     * 
     *   package {
     * import flash.globalization.NumberFormatter;
...
namespace globalization {
         ...
         * @playerversion   AIR 2
         */
        std::string NumberFormatter::lastOperationStatus()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string NumberFormatter::requestedLocaleIDName()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string NumberFormatter::actualLocaleIDName()         ;
         ...
         * @playerversion   AIR 2
         */
        int NumberFormatter::fractionalDigits()      ;
        void NumberFormatter::fractionalDigits(int value)       ;
         ...
         * @playerversion   AIR 2
         */
        bool NumberFormatter::useGrouping()          ;
        void NumberFormatter::useGrouping(bool value)       ;
         ...
         */
        std::string NumberFormatter::groupingPattern()         ;
        void NumberFormatter::groupingPattern(std::string value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        unsigned int NumberFormatter::digitsType()       ;
        void NumberFormatter::digitsType(unsigned int value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        std::string NumberFormatter::decimalSeparator()         ;
        void NumberFormatter::decimalSeparator(std::string value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        std::string NumberFormatter::groupingSeparator()         ;
        void NumberFormatter::groupingSeparator(std::string value)       ;
         ...
         */
        std::string NumberFormatter::negativeSymbol()         ;
        void NumberFormatter::negativeSymbol(std::string value)       ;
         ...
         */
        unsigned int NumberFormatter::negativeNumberFormat()       ;
        void NumberFormatter::negativeNumberFormat(unsigned int value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        bool NumberFormatter::leadingZero()          ;
        void NumberFormatter::leadingZero(bool value)       ;
         ...
         * @throws  TypeError if this property is assigned a null value.
         */
        bool NumberFormatter::trailingZeros()          ;
        void NumberFormatter::trailingZeros(bool value)       ;
         ...
         * @playerversion   AIR 2
         */
        std::vector<std::string> NumberFormatter::getAvailableLocaleIDNames()                  ;
         ...
         */
        NumberFormatter::NumberFormatter(std::string requestedLocaleIDName);
         ...
         */
        flash::globalization::NumberParseResult* NumberFormatter::parse(std::string parseString)                                        ;
         ...
         * @throws  TypeError if the parseString is null
         */
        float NumberFormatter::parseNumber(std::string parseString)         ;
         ...
         */
        std::string NumberFormatter::formatInt(int value)         ;
         ...
         */
        std::string NumberFormatter::formatUint(unsigned int value)         ;
         ...
         * @throws  MemoryError if there are any internal memory allocation problems.
         */
        std::string NumberFormatter::formatNumber(float value)         ;
}
}
