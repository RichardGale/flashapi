...
namespace globalization {
         ...
         * @playerversion   AIR 2
         */
        bool Collator::ignoreCase()          ;
        void Collator::ignoreCase(bool value)       ;
         ...
         * @playerversion   AIR 2
         */
        bool Collator::ignoreDiacritics()          ;
        void Collator::ignoreDiacritics(bool value)       ;
         ...
         * @playerversion   AIR 2
         */
        bool Collator::ignoreKanaType()          ;
        void Collator::ignoreKanaType(bool value)       ;
         ...
         * @playerversion   AIR 2
         */
        bool Collator::ignoreSymbols()          ;
        void Collator::ignoreSymbols(bool value)       ;
         ...
         * @playerversion   AIR 2
         */
        bool Collator::ignoreCharacterWidth()          ;
        void Collator::ignoreCharacterWidth(bool value)       ;
         ...
         * @playerversion   AIR 2
         */
        bool Collator::numericComparison()          ;
        void Collator::numericComparison(bool value)       ;
         ...
         * @playerversion   AIR 2
         */
        std::string Collator::lastOperationStatus()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string Collator::actualLocaleIDName()         ;
         ...
         * @playerversion   AIR 2
         */
        std::string Collator::requestedLocaleIDName()         ;
         ...
         */
        Collator::Collator(std::string requestedLocaleIDName, std::string initialMode);
         ...
         * @playerversion   AIR 2
         */
        std::vector<std::string> Collator::getAvailableLocaleIDNames()                  ;
         ...
         */
        int Collator::compare(std::string string1, std::string string2)      ;
         ...
         * @throws  ArgumentError when a parameter contains an invalid value.
         */
        bool Collator::equals(std::string string1, std::string string2)          ;
}
}
