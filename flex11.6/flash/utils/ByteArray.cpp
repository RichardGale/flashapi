...
namespace utils {
         ...
         * @playerversion   Lite 4
         */
        unsigned int ByteArray::defaultObjectEncoding()       ;
        void ByteArray::defaultObjectEncoding(unsigned int version)       ;
        ...
        void ByteArray::length(unsigned int value)       ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int ByteArray::bytesAvailable()       ;
        ...
        void ByteArray::position(unsigned int offset)       ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int ByteArray::objectEncoding()       ;
        void ByteArray::objectEncoding(unsigned int version)       ;
         ...
         * @playerversion   Lite 4
         */
        std::string ByteArray::endian()         ;
        void ByteArray::endian(std::string type)       ;

        bool ByteArray::shareable()          ;
        void ByteArray::shareable(bool newValue)       ;
         ...
         * @playerversion   Lite 4
         */
        void ByteArray::writeBytes(ByteArray* bytes, unsigned int offset, unsigned int length)       ;
         ...
         *   to read.
         */
        unsigned int ByteArray::readUnsignedShort()       ;
         ...
         *   to read.
         */
        std::string ByteArray::readMultiByte(unsigned int length, std::string charSet)         ;
         ...
         *   to read.
         */
        std::string ByteArray::readUTFBytes(unsigned int length)         ;
         ...
         * @playerversion   Lite 4
         */
        void ByteArray::writeObject(void* object)       ;
         ...
         * @playerversion   Flash 9
         */
        void ByteArray::compress(std::string algorithm)       ;
         ...
         *   same compression algorithm used to compress.
         */
        void ByteArray::uncompress(std::string algorithm)       ;
        ...
        int ByteArray::atomicCompareAndSwapIntAt(int byteIndex, int expectedValue, int newValue)      ;

        int ByteArray::atomicCompareAndSwapLength(int expectedLength, int newLength)      ;
}
}
