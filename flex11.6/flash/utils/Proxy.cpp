...
namespace utils {
         ...
         * @playerversion   Lite 4
         */
        void* Proxy::getProperty(void* name)    ;
         ...
         * @playerversion   Lite 4
         */
        void Proxy::setProperty(void* name, void* value)       ;
         ...
         * @playerversion   Lite 4
         */
        void* Proxy::callProperty(void* name, ...)    ;
         ...
         * @playerversion   Lite 4
         */
        bool Proxy::hasProperty(void* name)          ;
         ...
         * @playerversion   Lite 4
         */
        bool Proxy::deleteProperty(void* name)          ;
         ...
         * @playerversion   Lite 4
         */
        void* Proxy::getDescendants(void* name)    ;
         ...
         * @playerversion   Lite 4
         */
        int Proxy::nextNameIndex(int index)      ;
         ...
         * @playerversion   Lite 4
         */
        std::string Proxy::nextName(int index)         ;
         ...
         * @playerversion   Lite 4
         */
        void* Proxy::nextValue(int index)    ;
         ...
         * @playerversion   Lite 4
         */
        bool Proxy::isAttribute(void* name)          ;
}
}
