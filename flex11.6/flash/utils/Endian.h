#if !defined(FLEX11_6_FLASH_UTILS_ENDIAN_AS)
#define FLEX11_6_FLASH_UTILS_ENDIAN_AS
...
namespace flash
{
    namespace utils
    {
        class Endian : public Object
        {
             ...
             */
        public:
            static const std::string BIG_ENDIAN;
             ...
             */
        public:
            static const std::string LITTLE_ENDIAN;
...
#endif // FLEX11_6_FLASH_UTILS_ENDIAN_AS
#endif // __cplusplus
