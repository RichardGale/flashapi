#if !defined(FLEX11_6_FLASH_SAMPLER_DELETEOBJECTSAMPLE_AS)
#define FLEX11_6_FLASH_SAMPLER_DELETEOBJECTSAMPLE_AS
#if defined(__cplusplus)


/**
 * The DeleteObjectSample class represents objects that are created within a <codeph class="+ topic/ph pr-d/codeph ">getSamples()</codeph> stream; each
...
#endif // FLEX11_6_FLASH_SAMPLER_DELETEOBJECTSAMPLE_AS
#endif // __cplusplus
