...
#include "flash/display/ShaderData.h"
...
namespace display {
         ...
         * @playerversion   AIR 1.5
         */
        void Shader::byteCode(ByteArray* code)       ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::display::ShaderData* Shader::data()                           ;
        void Shader::data(ShaderData* p)       ;
         ...
         * @playerversion   AIR 1.5
         */
        std::string Shader::precisionHint()         ;
        void Shader::precisionHint(std::string p)       ;

        Shader::Shader(ByteArray* code);
}
}
