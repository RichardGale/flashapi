...
namespace display {
         ...
         * @playerversion   Flash 9
         */
        flash::text::TextSnapshot* DisplayObjectContainer::textSnapshot()                          ;
         ...
         */
        bool DisplayObjectContainer::tabChildren()          ;
        void DisplayObjectContainer::tabChildren(bool enable)       ;
         ...
         * @playerversion   Lite 4
         */
        bool DisplayObjectContainer::mouseChildren()          ;
        void DisplayObjectContainer::mouseChildren(bool enable)       ;
         ...
         */
        flash::display::DisplayObject* DisplayObjectContainer::addChild(DisplayObject* child)                              ;
         ...
         *   the caller is a child (or grandchild etc.) of the child being added.
         */
        flash::display::DisplayObject* DisplayObjectContainer::addChildAt(DisplayObject* child, int index)                              ;
         ...
         */
        flash::display::DisplayObject* DisplayObjectContainer::removeChild(DisplayObject* child)                              ;
         ...
         */
        flash::display::DisplayObject* DisplayObjectContainer::removeChildAt(int index)                              ;
         ...
         */
        flash::display::DisplayObject* DisplayObjectContainer::getChildAt(int index)                              ;
         ...
         *   the child movie call the Security.allowDomain() method.
         */
        flash::display::DisplayObject* DisplayObjectContainer::getChildByName(std::string name)                              ;
         ...
         * @playerversion   Lite 4
         */
        std::vector<void*> DisplayObjectContainer::getObjectsUnderPoint(Point* point)        ;
         ...
         * @playerversion   Lite 4
         */
        bool DisplayObjectContainer::areInaccessibleObjectsUnderPoint(Point* point)          ;
