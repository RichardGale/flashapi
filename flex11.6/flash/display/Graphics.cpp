...
#include "flash/display/IGraphicsPath.h"
#include "flash/display/IGraphicsFill.h"
#include "flash/display/IGraphicsStroke.h"
...
namespace display {
         ...
         */
        void Graphics::beginGradientFill(std::string type, std::vector<void*> colors, std::vector<void*> alphas, std::vector<void*> ratios, Matrix* matrix, std::string spreadMethod, std::string interpolationMethod, float focalPointRatio)       ;
         ...
         * @playerversion   Lite 4
         */
        void Graphics::beginBitmapFill(BitmapData* bitmap, Matrix* matrix, bool repeat, bool smooth)       ;
         ...
         */
        void Graphics::beginShaderFill(Shader* shader, Matrix* matrix)       ;
         ...
         * @playerversion   Flash 9
         */
        void Graphics::lineGradientStyle(std::string type, std::vector<void*> colors, std::vector<void*> alphas, std::vector<void*> ratios, Matrix* matrix, std::string spreadMethod, std::string interpolationMethod, float focalPointRatio)       ;
         ...
         *   </listing>
         */
        void Graphics::lineStyle(float thickness, unsigned int color, float alpha, bool pixelHinting, std::string scaleMode, std::string caps, std::string joints, float miterLimit)       ;
        ...
        void Graphics::drawRoundRectComplex(float x, float y, float width, float height, float topLeftRadius, float topRightRadius, float bottomLeftRadius, float bottomRightRadius)       ;
        ...
        void Graphics::cubicCurveTo(float controlX1, float controlY1, float controlX2, float controlY2, float anchorX, float anchorY)       ;
         ...
         * @playerversion   Lite 4
         */
        void Graphics::copyFrom(Graphics* sourceGraphics)       ;
         ...
         * @playerversion   AIR 1.5
         */
        void Graphics::lineBitmapStyle(BitmapData* bitmap, Matrix* matrix, bool repeat, bool smooth)       ;
         ...
         * @playerversion   AIR 1.5
         */
        void Graphics::lineShaderStyle(Shader* shader, Matrix* matrix)       ;
         ...
         * @playerversion   AIR 1.5
         */
        void Graphics::drawPath(std::vector<int> commands, std::vector<float> data, std::string winding)       ;
         ...
         * @playerversion   AIR 1.5
         */
        void Graphics::drawTriangles(std::vector<float> vertices, std::vector<int> indices, std::vector<float> uvtData, std::string culling)       ;
         ...
         * @playerversion   AIR 1.5
         */
        void Graphics::drawGraphicsData(std::vector<flash::display::IGraphicsData*> graphicsData)       ;

        std::vector<IGraphicsData*> Graphics::readGraphicsData(bool recurse)                         ;
}
}
