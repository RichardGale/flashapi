#if !defined(FLEX11_6_FLASH_DISPLAY_DISPLAYOBJECTCONTAINER_AS)
#define FLEX11_6_FLASH_DISPLAY_DISPLAYOBJECTCONTAINER_AS
...
namespace flash
{
    namespace display
    {
        ...
        public:
             ...
             */
        public:
            flash::display::DisplayObject *removeChild(DisplayObject *child);
        ...
        public:
             ...
             */
        public:
            flash::display::DisplayObject *getChildAt(int index);
             ...
             */
        public:
            flash::display::DisplayObject *getChildByName(std::string name);
...
#endif // FLEX11_6_FLASH_DISPLAY_DISPLAYOBJECTCONTAINER_AS
#endif // __cplusplus
