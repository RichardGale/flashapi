...
namespace display {
         ...
         * @playerversion   Lite 4
         */
        flash::display::Graphics* Sprite::graphics()                         ;
         ...
         * @playerversion   Lite 4
         */
        bool Sprite::buttonMode()          ;
        void Sprite::buttonMode(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::display::DisplayObject* Sprite::dropTarget()                              ;
         ...
         * @playerversion   Lite 4
         */
        flash::display::Sprite* Sprite::hitArea()                       ;
         ...
         * @playerversion   AIR 1.0
         */
        bool Sprite::useHandCursor()          ;
        void Sprite::useHandCursor(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::media::SoundTransform* Sprite::soundTransform()                             ;
        void Sprite::soundTransform(SoundTransform* sndTransform)       ;
         ...
         * @playerversion   Lite 4
         */
        void Sprite::startTouchDrag(int touchPointID, bool lockCenter, Rectangle* bounds)       ;
         ...
         * @playerversion   Lite 4
         */
        void Sprite::stopTouchDrag(int touchPointID)       ;
}
}
