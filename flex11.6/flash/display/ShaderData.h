#if !defined(FLEX11_6_FLASH_DISPLAY_SHADERDATA_AS)
#define FLEX11_6_FLASH_DISPLAY_SHADERDATA_AS
...
namespace flash
{
    namespace display
    {
        class ShaderData: public Object
        {
             ...
             */
        public:
            ShaderData(ByteArray *byteCode);
        };
    }
}

#endif // FLEX11_6_FLASH_DISPLAY_SHADERDATA_AS
#endif // __cplusplus
