#if !defined(FLEX11_6_FLASH_DISPLAY_GRAPHICSPATHWINDING_AS)
#define FLEX11_6_FLASH_DISPLAY_GRAPHICSPATHWINDING_AS
...
namespace flash
{
    namespace display
    {
        class GraphicsPathWinding : public Object
        {
             ...
             */
        public:
            static const std::string EVEN_ODD;
             ...
             */
        public:
            static const std::string NON_ZERO;
...
#endif // FLEX11_6_FLASH_DISPLAY_GRAPHICSPATHWINDING_AS
#endif // __cplusplus
