...
namespace display {
         ...
         */
        flash::display::DisplayObject* DisplayObject::root()                              ;
         ...
         * @playerversion   Lite 4
         */
        flash::display::Stage* DisplayObject::stage()                      ;
         ...
         */
        flash::display::DisplayObjectContainer* DisplayObject::parent()                                       ;
         ...
         * @playerversion   Lite 4
         */
        flash::display::DisplayObject* DisplayObject::mask()                              ;
         ...
         * @playerversion   Lite 4
         */
        bool DisplayObject::cacheAsBitmap()          ;
        void DisplayObject::cacheAsBitmap(bool value)       ;
         ...
         * @playerversion   Lite 4
         */
        Object* DisplayObject::opaqueBackground()         ;
        void DisplayObject::opaqueBackground(Object* value)       ;
         ...
         * @playerversion   Flash 9
         */
        flash::geom::Rectangle* DisplayObject::scrollRect()                       ;
        void DisplayObject::scrollRect(Rectangle* value)       ;
         ...
         */
        std::vector<void*> DisplayObject::filters()        ;
        void DisplayObject::filters(std::vector<void*> value)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Transform* DisplayObject::transform()                       ;
        void DisplayObject::transform(Transform* value)       ;
         ...
         */
        flash::geom::Rectangle* DisplayObject::scale9Grid()                       ;
        void DisplayObject::scale9Grid(Rectangle* innerRectangle)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::display::LoaderInfo* DisplayObject::loaderInfo()                           ;
         ...
         * @playerversion   Flash 9
         */
        flash::accessibility::AccessibilityProperties* DisplayObject::accessibilityProperties()                                              ;
        void DisplayObject::accessibilityProperties(AccessibilityProperties* value)       ;
         ...
         *   property for more information.
         */
        void DisplayObject::blendShader(Shader* value)       ;

        Object* DisplayObject::metaData()         ;
        void DisplayObject::metaData(Object* data)       ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Point* DisplayObject::globalToLocal(Point* point)                   ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Point* DisplayObject::localToGlobal(Point* point)                   ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Rectangle* DisplayObject::getBounds(DisplayObject* targetCoordinateSpace)                       ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Rectangle* DisplayObject::getRect(DisplayObject* targetCoordinateSpace)                       ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Vector3D* DisplayObject::globalToLocal3D(Point* point)                      ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Point* DisplayObject::local3DToGlobal(Vector3D* point3d)                   ;
}
}
