...
namespace display {
         ...
         * @playerversion   AIR 1.5
         */
        Object* ShaderInput::input()         ;
        void ShaderInput::input(Object* input)       ;
         ...
         * @playerversion   AIR 1.5
         */
        int ShaderInput::width()      ;
        void ShaderInput::width(int value)       ;
         ...
         * @playerversion   AIR 1.5
         */
        int ShaderInput::height()      ;
        void ShaderInput::height(int value)       ;
