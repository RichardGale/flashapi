...
namespace display {
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Rectangle* BitmapData::rect()                       ;
         ...
         */
        BitmapData::BitmapData(int width, int height, bool transparent, unsigned int fillColor);
         ...
         * @playerversion   Lite 4
         */
        flash::display::BitmapData* BitmapData::clone()                           ;
         ...
         * @playerversion   Lite 4
         */
        unsigned int BitmapData::getPixel32(int x, int y)       ;
         ...
         * @playerversion   Lite 4
         */
        void BitmapData::setPixel32(int x, int y, unsigned int color)       ;
         ...
         */
        void BitmapData::applyFilter(BitmapData* sourceBitmapData, Rectangle* sourceRect, Point* destPoint, BitmapFilter* filter)       ;
         ...
         */
        Object* BitmapData::compare(BitmapData* otherBitmapData)         ;
         ...
         */
        void BitmapData::draw(IBitmapDrawable* source, Matrix* matrix, ColorTransform* colorTransform, std::string blendMode, Rectangle* clipRect, bool smoothing)       ;

        void BitmapData::drawWithQuality(IBitmapDrawable* source, Matrix* matrix, ColorTransform* colorTransform, std::string blendMode, Rectangle* clipRect, bool smoothing, std::string quality)       ;
         ...
         * @playerversion   Lite 4
         */
        void BitmapData::floodFill(int x, int y, unsigned int color)       ;
         ...
         */
        flash::geom::Rectangle* BitmapData::generateFilterRect(Rectangle* sourceRect, BitmapFilter* filter)                       ;
         ...
         * @playerversion   Lite 4
         */
        flash::geom::Rectangle* BitmapData::getColorBoundsRect(unsigned int mask, unsigned int color, bool findColor)                       ;
         ...
         * @throws  TypeError The rect is null.
         */
        flash::utils::ByteArray* BitmapData::getPixels(Rectangle* rect)                        ;
         ...
         * @throws  TypeError The rect is null.
         */
        std::vector<unsigned int> BitmapData::getVector(Rectangle* rect)                ;
         ...
         */
        bool BitmapData::hitTest(Point* firstPoint, unsigned int firstAlphaThreshold, Object* secondObject, Point* secondBitmapDataPoint, unsigned int secondAlphaThreshold)          ;
         ...
         * @throws  TypeError The sourceBitmapData, sourceRect or destPoint are null.
         */
        void BitmapData::merge(BitmapData* sourceBitmapData, Rectangle* sourceRect, Point* destPoint, unsigned int redMultiplier, unsigned int greenMultiplier, unsigned int blueMultiplier, unsigned int alphaMultiplier)       ;
         ...
         * @playerversion   AIR 1.0
         */
        void BitmapData::noise(int randomSeed, unsigned int low, unsigned int high, unsigned int channelOptions, bool grayScale)       ;
         ...
         * @throws  TypeError The sourceBitmapData, sourceRect or destPoint are null.
         */
        void BitmapData::paletteMap(BitmapData* sourceBitmapData, Rectangle* sourceRect, Point* destPoint, std::vector<void*> redArray, std::vector<void*> greenArray, std::vector<void*> blueArray, std::vector<void*> alphaArray)       ;
         ...
         * @playerversion   AIR 1.0
         */
        void BitmapData::perlinNoise(float baseX, float baseY, unsigned int numOctaves, int randomSeed, bool stitch, bool fractalNoise, unsigned int channelOptions, bool grayScale, std::vector<void*> offsets)       ;
         ...
         */
        int BitmapData::pixelDissolve(BitmapData* sourceBitmapData, Rectangle* sourceRect, Point* destPoint, int randomSeed, int numPixels, unsigned int fillColor)      ;
         ...
         * @playerversion   AIR 1.0
         */
        void BitmapData::scroll(int x, int y)       ;
         ...
         */
        void BitmapData::setPixels(Rectangle* rect, ByteArray* inputByteArray)       ;
         ...
         */
        void BitmapData::setVector(Rectangle* rect, std::vector<unsigned int> inputVector)       ;
         ...
         */
        unsigned int BitmapData::threshold(BitmapData* sourceBitmapData, Rectangle* sourceRect, Point* destPoint, std::string operation, unsigned int threshold, unsigned int color, unsigned int mask, bool copySource)       ;
         ...
         * @playerversion   AIR 1.0
         */
        void BitmapData::unlock(Rectangle* changeRect)       ;
         ...
         * @playerversion   Lite 4
         */
        std::vector<float> BitmapData::histogram(Rectangle* hRect)                  ;

        ByteArray* BitmapData::encode(Rectangle* rect, Object* compressor, ByteArray* byteArray)            ;
}
}
