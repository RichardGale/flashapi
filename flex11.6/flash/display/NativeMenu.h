#if !defined(FLEX11_6_FLASH_DISPLAY_NATIVEMENU_AS)
#define FLEX11_6_FLASH_DISPLAY_NATIVEMENU_AS
...
namespace flash
{
    namespace display
    {
         ...
         */
        class NativeMenu : public flash::events::EventDispatcher
        {
            /**
...
#endif // FLEX11_6_FLASH_DISPLAY_NATIVEMENU_AS
#endif // __cplusplus
