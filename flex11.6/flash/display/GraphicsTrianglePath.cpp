...
#include "GraphicsTrianglePath.h"
...
namespace display {
         ...
         * @playerversion   AIR 1.5
         */
        std::string GraphicsTrianglePath::culling()         ;
        void GraphicsTrianglePath::culling(std::string value)       ;
         ...
         * @playerversion   AIR 1.5
         */
        GraphicsTrianglePath::GraphicsTrianglePath(std::vector<float> vertices, std::vector<int> indices, std::vector<float> uvtData, std::string culling);
}
}
