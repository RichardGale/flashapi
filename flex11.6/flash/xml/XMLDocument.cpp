...
namespace xml {
         ...
         *   </listing>
         */
        flash::xml::XMLNode* XMLDocument::createElement(std::string name)                    ;
         ...
         *   </listing>
         */
        flash::xml::XMLNode* XMLDocument::createTextNode(std::string text)                    ;
         ...
         *   </listing>
         */
        void XMLDocument::parseXML(std::string source)       ;
         ...
         *   </listing>
         */
        XMLDocument::XMLDocument(std::string source);
}
}
