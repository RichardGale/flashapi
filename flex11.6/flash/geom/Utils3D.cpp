...
namespace geom {
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Vector3D* Utils3D::projectVector(Matrix3D* m, Vector3D* v)                      ;
         ...
         * @playerversion   AIR 1.5
         */
        void Utils3D::projectVectors(Matrix3D* m, std::vector<float> verts, std::vector<float> projectedVerts, std::vector<float> uvts)       ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Matrix3D* Utils3D::pointTowards(float percent, Matrix3D* mat, Vector3D* pos, Vector3D* at, Vector3D* up)                      ;
