#if !defined(FLEX11_6_FLASH_GEOM_ORIENTATION3D_AS)
#define FLEX11_6_FLASH_GEOM_ORIENTATION3D_AS
...
namespace flash
{
    namespace geom
    {
        class Orientation3D : public Object
        {
             ...
             */
        public:
            static const std::string EULER_ANGLES;
             ...
             */
        public:
            static const std::string AXIS_ANGLE;
...
#endif // FLEX11_6_FLASH_GEOM_ORIENTATION3D_AS
#endif // __cplusplus
