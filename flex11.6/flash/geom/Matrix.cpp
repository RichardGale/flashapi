...
namespace geom {
         ...
         *   </listing>
         */
        flash::geom::Matrix* Matrix::clone()                    ;
         ...
         *   </listing>
         */
        flash::geom::Point* Matrix::deltaTransformPoint(Point* point)                   ;
         ...
         *   </listing>
         */
        flash::geom::Point* Matrix::transformPoint(Point* point)                   ;
        ...
        void Matrix::copyFrom(Matrix* sourceMatrix)       ;

        void Matrix::setTo(float aa, float ba, float ca, float da, float txa, float tya)       ;

        void Matrix::copyRowTo(unsigned int row, Vector3D* vector3D)       ;

        void Matrix::copyColumnTo(unsigned int column, Vector3D* vector3D)       ;

        void Matrix::copyRowFrom(unsigned int row, Vector3D* vector3D)       ;

        void Matrix::copyColumnFrom(unsigned int column, Vector3D* vector3D)       ;
}
}
