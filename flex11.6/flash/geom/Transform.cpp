...
#include "flash/geom/PerspectiveProjection.h"
...
namespace geom {
         ...
         */
        flash::geom::Matrix* Transform::matrix()                    ;
        void Transform::matrix(Matrix* value)       ;
         ...
         */
        flash::geom::ColorTransform* Transform::colorTransform()                            ;
        void Transform::colorTransform(ColorTransform* value)       ;
         ...
         *   </listing>
         */
        flash::geom::Matrix* Transform::concatenatedMatrix()                    ;
         ...
         *   </listing>
         */
        flash::geom::ColorTransform* Transform::concatenatedColorTransform()                            ;
         ...
         *   </listing>
         */
        flash::geom::Rectangle* Transform::pixelBounds()                       ;
         ...
         */
        flash::geom::Matrix3D* Transform::matrix3D()                      ;
        void Transform::matrix3D(Matrix3D* m)       ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::PerspectiveProjection* Transform::perspectiveProjection()                                   ;
        void Transform::perspectiveProjection(PerspectiveProjection* pm)       ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Matrix3D* Transform::getRelativeMatrix3D(DisplayObject* relativeTo)                      ;

        Transform::Transform(DisplayObject* displayObject);
}
}
