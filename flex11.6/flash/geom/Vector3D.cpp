...
namespace geom {
         ...
         * @playerversion   AIR 1.5
         */
        float Vector3D::angleBetween(Vector3D* a, Vector3D* b)         ;
         ...
         * @playerversion   AIR 1.5
         */
        float Vector3D::distance(Vector3D* pt1, Vector3D* pt2)         ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Vector3D* Vector3D::clone()                      ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Vector3D* Vector3D::crossProduct(Vector3D* a)                      ;
         ...
         * @playerversion   AIR 1.5
         */
        void Vector3D::incrementBy(Vector3D* a)       ;
         ...
         * @playerversion   AIR 1.5
         */
        void Vector3D::decrementBy(Vector3D* a)       ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Vector3D* Vector3D::add(Vector3D* a)                      ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Vector3D* Vector3D::subtract(Vector3D* a)                      ;
         ...
         * @playerversion   AIR 1.5
         */
        bool Vector3D::equals(Vector3D* toCompare, bool allFour)          ;
         ...
         * @playerversion   AIR 1.5
         */
        bool Vector3D::nearEquals(Vector3D* toCompare, float tolerance, bool allFour)          ;
        ...
        void Vector3D::copyFrom(Vector3D* sourceVector3D)       ;
