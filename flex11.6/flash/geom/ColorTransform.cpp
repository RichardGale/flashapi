...
namespace geom {
         ...
         */
        unsigned int ColorTransform::color()       ;
        void ColorTransform::color(unsigned int newColor)       ;
         ...
         * @playerversion   Lite 4
         */
        ColorTransform::ColorTransform(float redMultiplier, float greenMultiplier, float blueMultiplier, float alphaMultiplier, float redOffset, float greenOffset, float blueOffset, float alphaOffset);
