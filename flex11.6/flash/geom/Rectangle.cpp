...
namespace geom {
         ...
         *   </listing>
         */
        flash::geom::Point* Rectangle::topLeft()                   ;
        void Rectangle::topLeft(Point* value)       ;
         ...
         *   </listing>
         */
        flash::geom::Point* Rectangle::bottomRight()                   ;
        void Rectangle::bottomRight(Point* value)       ;
         ...
         *   </listing>
         */
        flash::geom::Point* Rectangle::size()                   ;
        void Rectangle::size(Point* value)       ;
         ...
         *   </listing>
         */
        flash::geom::Rectangle* Rectangle::clone()                       ;
         ...
         *   </listing>
         */
        flash::geom::Rectangle* Rectangle::intersection(Rectangle* toIntersect)                       ;
         ...
         *   </listing>
         */
        flash::geom::Rectangle* Rectangle::UNION(Rectangle* toUnion)                       ;
