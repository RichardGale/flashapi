#if !defined(FLEX11_6_FLASH_GEOM_MATRIX3D_AS)
#define FLEX11_6_FLASH_GEOM_MATRIX3D_AS
...
namespace flash
{
    namespace geom
    {
        ...
        public:
             ...
             */
        public:
            static flash::geom::Matrix3D *interpolate(Matrix3D *thisMat, Matrix3D *toMat, float percent);
             ...
             */
        public:
            flash::geom::Matrix3D *clone();

        public:
            void     copyToMatrix3D(Matrix3D *dest);
        ...
        public:
             ...
             */
        public:
            flash::geom::Vector3D *transformVector(Vector3D *v);
             ...
             */
        public:
            flash::geom::Vector3D *deltaTransformVector(Vector3D *v);
        ...
        public:
             ...
             */
        public:
            void     interpolateTo(Matrix3D *toMat, float percent);
...
#endif // FLEX11_6_FLASH_GEOM_MATRIX3D_AS
#endif // __cplusplus
