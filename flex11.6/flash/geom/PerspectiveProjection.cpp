...
namespace geom {
         ...
         * @playerversion   AIR 1.5
         */
        float PerspectiveProjection::fieldOfView()         ;
        void PerspectiveProjection::fieldOfView(float fieldOfViewAngleInDegrees)       ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Point* PerspectiveProjection::projectionCenter()                   ;
        void PerspectiveProjection::projectionCenter(Point* p)       ;
         ...
         * @playerversion   AIR 1.5
         */
        float PerspectiveProjection::focalLength()         ;
        void PerspectiveProjection::focalLength(float value)       ;
         ...
         * @playerversion   AIR 1.5
         */
        flash::geom::Matrix3D* PerspectiveProjection::toMatrix3D()                      ;
}
}
