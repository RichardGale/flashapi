#if !defined(FLEX11_6_FLASH_GEOM_POINT_AS)
#define FLEX11_6_FLASH_GEOM_POINT_AS
...
namespace flash
{
    namespace geom
    {
        ...
        public:
             ...
             */
        public:
            static flash::geom::Point *interpolate(Point *pt1, Point *pt2, float f);
        ...
        public:
             ...
             */
        public:
            flash::geom::Point *subtract(Point *v);
...
#endif // FLEX11_6_FLASH_GEOM_POINT_AS
#endif // __cplusplus
