     ...
     */
         ...
         * @playerversion   Lite 4
         */
        float Math::cos(float angleRadians)         ;
         ...
         * @playerversion   Lite 4
         */
        float Math::sin(float angleRadians)         ;
         ...
         * @playerversion   Lite 4
         */
        float Math::tan(float angleRadians)         ;
         ...
         * @playerversion   Lite 4
         */
        float Math::pow(float base, float pow)         ;
