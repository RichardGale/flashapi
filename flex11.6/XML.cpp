     ...
     */
         ...
         * @playerversion   Flash 9
         */
        bool XML::ignoreComments()          ;
        void XML::ignoreComments(bool newIgnore)       ;
         ...
         * @playerversion   Flash 9
         */
        bool XML::ignoreProcessingInstructions()          ;
        void XML::ignoreProcessingInstructions(bool newIgnore)       ;
         ...
         * @playerversion   Flash 9
         */
        bool XML::ignoreWhitespace()          ;
        void XML::ignoreWhitespace(bool newIgnore)       ;
         ...
         * @playerversion   Flash 9
         */
        bool XML::prettyPrinting()          ;
        void XML::prettyPrinting(bool newPretty)       ;
         ...
         * @playerversion   Flash 9
         */
        int XML::prettyIndent()      ;
        void XML::prettyIndent(int newIndent)       ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */bool XML::hasOwnProperty(void* P)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */bool XML::propertyIsEnumerable(void* P)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XML* XML::appendChild(void* child)      ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XML::attribute(void* arg)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XML::child(void* propertyName)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XML::descendants(void* name)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XML::elements(void* name)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */std::vector<void*> XML::inScopeNamespaces()        ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */void* XML::insertChildAfter(void* child1, void* child2)    ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */void* XML::insertChildBefore(void* child1, void* child2)    ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */std::vector<void*> XML::namespaceDeclarations()        ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XMLList* XML::processingInstructions(void* name)          ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XML* XML::prependChild(void* value)      ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XML* XML::removeNamespace(void* ns)      ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XML* XML::replace(void* propertyName, void* value)      ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */XML* XML::setChildren(void* value)      ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */void XML::setLocalName(void* name)       ;
         ...
         * @langversion 3.0
         * @playerversion   Flash 9
         */std::string XML::toXMLString()         ;Function* XML::notification()           ;void* XML::setNotification(Function* f)    ;void* XML::toJSON(std::string k)    ;
