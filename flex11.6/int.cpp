     ...
     */
         ...
         * @playerversion   Lite 4
         */
        const int int::MIN_VALUE   = -2147483648;
         ...
         * @playerversion   Lite 4
         */
        const int int::MAX_VALUE   = 2147483647;
        const int int::length  ;
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */std::string int::toString(void* radix)         ;
         ...
         */std::string int::toExponential(void* p)         ;
         ...
         */std::string int::toPrecision(void* p)         ;
