     ...
     */
         ...
         * @playerversion   Flash 9
         * @playerversion   Lite 4
         */std::string uint::toString(void* radix)         ;
         ...
         */std::string uint::toExponential(void* p)         ;
         ...
         */std::string uint::toPrecision(void* p)         ;
         ...
         * @playerversion   Lite 4
         * @throws  RangeError Throws an exception if the fractionDigits argument is outside the range 0 to 20.
         */std::string uint::toFixed(void* p)         ;
